...
%token_type {union _Ncp1_Ntoken_data}
...
expr_int(l) ::= NUM_F64(e).
   { l.basic.id = _Ncp1_Pexpr_f64_1(e.f64.f64); }
...
valueonly(l) ::= gvarExpr(r).
   { l.basic.id = r.basic.id; }
gvarExpr(l) ::= DOT ID(r).
   { l.basic.id = _Ncp1_Pexpr_gvar_4(-1, r.basic.id, r.basic.row, r.basic.col); }
gvarExpr(l) ::= at(at) DOT ID(r).
   { l.basic.id = _Ncp1_Pexpr_gvar_4(at.basic.id, r.basic.id, r.basic.row, r.basic.col); }
fvarExpr(l) ::= value4fix(e) DOT ID(r).
   { l.basic.id = _Ncp1_Pexpr_fvar_4(e.basic.id, r.basic.id, r.basic.row, r.basic.col); }
soaFieldExpr(l) ::= value4fix(e) SOA_FIELD(f).
   { l.basic.id = _Ncp1_Pexpr_soa_field_5(e.basic.id, f.basic.id, f.basic.id2, f.basic.row, f.basic.col); }
