...
size_t _Lin_size_8;
uint8_t* _Lin_data_9;
union _Nglc_Nrdr _Lr_end_29;
struct _Nglc_Nparser* _Lpsr_30;
struct _Nglc_Nlexer _Llex_31;
int32_t _Lnext_row_32;
int32_t _Lnext_col_33;
struct _Nglc_Ntoken_data _Ltok_34;
union _Nglc_Nwtr _Lw_begin_42;
union _Nglc_Nwtr _Lw_43;
int32_t _Lid_bit8_c_45;
_Nglc_Nat _Lat_bit8_c_47;
char* _Lout_path_50;
...
union _Nglc_Nrdr _Lr_end_11;
union _Nglc_Nrdr _Lr_12;
void* _Lnew_data_13;
union _Nglc_Nwtr _Lw_14;
union _Nglc_Nwtr _Lw_begin_28;
...
int32_t _Lrow_15;
int32_t _Lcol_16;
_Nglc_Pget_row_col_4(&_Lrow_15, &_Lcol_16, _Lr_12._Fref, _Lin_data_9);
...
int32_t _Lrow_17;
int32_t _Lcol_18;
_Nglc_Pget_row_col_4(&_Lrow_17, &_Lcol_18, _Lr_12._Fref, _Lin_data_9);
...
int32_t _Lrow_20;
int32_t _Lcol_21;
_Nglc_Pget_row_col_4(&_Lrow_20, &_Lcol_21, _Lr_12._Fref, _Lin_data_9);
...
_Nglc_Pparse_string_4(&_Lr_12, &_Lw_14, '_', _Lin_data_9);
goto continue_2;
} else if(_Lr_12._Fp1[1] == '+') {
_Nglc_Pparse_string_4(&_Lr_12, &_Lw_14, '+', _Lin_data_9);
goto continue_2;
...
int32_t _Lrow_22;
int32_t _Lcol_23;
_Nglc_Pget_row_col_4(&_Lrow_22, &_Lcol_23, _Lr_12._Fref, _Lin_data_9);
...
int32_t _Lrow_24;
int32_t _Lcol_25;
_Nglc_Pget_row_col_4(&_Lrow_24, &_Lcol_25, _Lr_12._Fref, _Lin_data_9);
...
int32_t _Lrow_26;
int32_t _Lcol_27;
_Nglc_Pget_row_col_4(&_Lrow_26, &_Lcol_27, _Lr_12._Fref, _Lin_data_9);
...
_Nglc_Ppreprocess_2(&_Lin_data_9, &_Lin_size_8);
}
}
_Lr_end_29._Fref = _Lin_data_9;
_Lr_end_29._Fpos += _Lin_size_8;
_Nglc_Pparse_str_init_1(_Lin_size_8);
_Gid_cap = 64;
...
_Lpsr_30 = _Nglc_Nparser_Palloc_0();
_Nglc_Nlexer_Pinit_3(&_Llex_31, _Lin_data_9, _Lin_size_8);
_Lnext_row_32 = 1;
_Lnext_col_33 = 1;
_Grow = 1;
_Gcol = 1;
...
_Lt_35 = glc_lexer_scan(&_Llex_31);
if(true) {
uint8_t* _Lpos_36;
...
if(((_Lt_35 >= _Nglc_Ntoken_Cid_colon) && (_Lt_35 < _Nglc_Ntoken_Cid))) {
_Ltok_34._Fid = _Nglc_Nlexer_Pget_id_3(&_Llex_31, 1, 0);
glcParse(_Lpsr_30, _Lt_35, &_Ltok_34);
} else {
switch(_Lt_35) {
...
union _Nglc_Nrdr _Lr_38;
_Lr_38._Fref = _Llex_31._Fstart;
_Ltok_34._Fid = _Nglc_Pchar_escape_value_1(_Lr_38._Fp1[3]);
glcParse(_Lpsr_30, _Lt_35, &_Ltok_34);
break;
case _Nglc_Ntoken_Cspace_at_real_name_str:;
union _Nglc_Nrdr _Lr_start_39;
int32_t _Lstart_40;
...
break_8:;
_Ltok_34._Fid = _Nglc_Nlexer_Pget_id_3(&_Llex_31, _Lstart_40, 1);
glcParse(_Lpsr_30, _Lt_35, &_Ltok_34);
break;
case _Nglc_Ntoken_Cnum_dec:;
_Ltok_34._Fid = _Nglc_Nlexer_Pget_u32_dec_1(&_Llex_31);
glcParse(_Lpsr_30, _Lt_35, &_Ltok_34);
break;
case _Nglc_Ntoken_Cnum_oct:;
_Ltok_34._Fid = _Nglc_Nlexer_Pget_u32_oct_1(&_Llex_31);
glcParse(_Lpsr_30, _Lt_35, &_Ltok_34);
break;
case _Nglc_Ntoken_Cinclude:;
_Ltok_34._Fid = _Nglc_Nlexer_Pget_include_1(&_Llex_31);
glcParse(_Lpsr_30, _Lt_35, &_Ltok_34);
break;
case _Nglc_Ntoken_Cid:;
_Ltok_34._Fid = _Nglc_Nlexer_Pget_id_3(&_Llex_31, 0, 0);
if(_Llex_31._Fcursor[0] == '(') {
_Lt_35 = _Nglc_Ntoken_Cid_lparen;
}
glcParse(_Lpsr_30, _Lt_35, &_Ltok_34);
break;
default:;
...
break_6:;
glcParse(_Lpsr_30, _Nglc_Ntoken_Cnil, &_Ltok_34);
_Nglc_Nparser_Pfree_1(_Lpsr_30);
...
i --;
_Nglc_Nwtr_Pn1_2(&_Lw_43, _Gid_len_v[_Li_44]);
_Nglc_Nwtr_Pcopy_3(&_Lw_43, _Gid_str_v[_Li_44], _Gid_len_v[_Li_44]);
_Nglc_Nwtr_Pn1_2(&_Lw_43, 0);
continue_10:;
_Li_44++;
}
break_10:;
_Lid_bit8_c_45 = ((_Gid_c + 7) >> 3);
_Nglc_Pmalloc_arr_2(_Gid_in_header_v, _Lid_bit8_c_45);
...
i --;
_Nglc_Nwtr_Pn1_2(&_Lw_43, _Ginclude_len_v[_Li_46]);
_Nglc_Nwtr_Pcopy_3(&_Lw_43, _Ginclude_str_v[_Li_46], _Ginclude_len_v[_Li_46]);
_Nglc_Nwtr_Pn1_2(&_Lw_43, 0);
continue_11:;
_Li_46++;
}
...
_Nglc_Pmalloc_arr_2(_Gat_in_header_v, _Lat_bit8_c_47);
...
i --;
struct _Nglc_Nat_data* _Lat_49;
_Lat_49 = (&_Gat_v[_Li_48]);
_Nglc_Nname_type_Pwr_2((*_Lat_49)._Ftype, &_Lw_43);
if((*_Lat_49)._Ftype == _Nglc_Nname_type_Cbasic) {
_Nglc_Nbasic_type_id_Pwr_2((*_Lat_49)._Fname._Fbasic, &_Lw_43);
} else {
_Nglc_Nat_Pwr_3((*_Lat_49)._Fparent, &_Lw_43, false);
_Nglc_Nid_Pwr_3((*_Lat_49)._Fname._Fid, &_Lw_43, false);
}
continue_12:;
_Li_48++;
}
break_12:;
_Nglc_Pwrite_cvar_2(&_Lw_43, false);
_Nglc_Pwrite_gvar_2(&_Lw_43, false);
_Nglc_Pwrite_enum_2(&_Lw_43, false);
_Nglc_Pwrite_struct_2(&_Lw_43, false);
_Nglc_Pwrite_func_2(&_Lw_43, false);
...
_Nglc_Nwtr_Pn1_2(&_Lw_43, _Gid_len_v[_Li_54]);
_Nglc_Nwtr_Pcopy_3(&_Lw_43, _Gid_str_v[_Li_54], _Gid_len_v[_Li_54]);
_Nglc_Nwtr_Pn1_2(&_Lw_43, 0);
continue_13:;
_Lj_53++;
}
...
for(int i = _Ginclude_c; i > 0; ) {
i --;
_Nglc_Nwtr_Pn1_2(&_Lw_43, _Ginclude_len_v[_Li_55]);
_Nglc_Nwtr_Pcopy_3(&_Lw_43, _Ginclude_str_v[_Li_55], _Ginclude_len_v[_Li_55]);
_Nglc_Nwtr_Pn1_2(&_Lw_43, 0);
continue_14:;
_Li_55++;
}
...
i --;
uint32_t _Li_57;
struct _Nglc_Nat_data* _Lat_58;
_Li_57 = _Gat_in_header_at_v[_Lj_56];
_Lat_58 = (&_Gat_v[_Li_57]);
_Nglc_Nname_type_Pwr_2((*_Lat_58)._Ftype, &_Lw_43);
if((*_Lat_58)._Ftype == _Nglc_Nname_type_Cbasic) {
_Nglc_Nbasic_type_id_Pwr_2((*_Lat_58)._Fname._Fbasic, &_Lw_43);
} else {
_Nglc_Nat_Pwr_header_2((*_Lat_58)._Fparent, &_Lw_43);
_Nglc_Nid_Pwr_header_2((*_Lat_58)._Fname._Fid, &_Lw_43);
}
continue_15:;
_Lj_56++;
}
break_15:;
_Nglc_Pwrite_cvar_2(&_Lw_43, true);
_Nglc_Pwrite_gvar_2(&_Lw_43, true);
_Nglc_Pwrite_enum_2(&_Lw_43, true);
_Nglc_Pwrite_struct_2(&_Lw_43, true);
_Nglc_Pwrite_func_2(&_Lw_43, true);
...
_Lok_18 = _Nglc_Ppreprocess_def_get_2(_Ldef_str_16, _Ldef_len_17);
if(_Linvert_13) {
_Lok_18 = !_Lok_18;
}
