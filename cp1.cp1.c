...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_23, "Error, [output.c] (which is '", 29u);
_Tchar_Pstdout_arr_2(_Lc_path_21, &_L_23);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_23, "') must be a filename that ends with '.c', for example: main.c\n", 63u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_45, "Error, cannot open file for reading: ", 37u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_48, "Error, cannot open file for reading: ", 37u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_51, "Error, cannot open file for reading: ", 37u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_1, " [command] [options]\n"
"Commands:\n"
"  c     Build a C file.\n"
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_1, "Usage: ", 7u);
_Tchar_Pstdout_arr_2(_Lbin_0, &_L_1);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_1, " c [output.c] [cp1 file/s...]\n", 30u);
_NLibCp1_NStdOut_Pstdout_end_1(&_L_1);
}
bool _Pvalidate_cp1_paths_5(int32_t _Lstart_0, int32_t _Larg_c_1, char** _Larg_v_2, char* _Lbin_3, _NCmd _Lcmd_4) {
int32_t _Li_5;
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_7, "') must be a relative filepath (e.g. file.cp1), not an absolute path (/home/user/file.cp1)\n", 91u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_10, "') must not contain backslashes '\\', please use forward slashes '/' instead\n", 76u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_12, "Error, [cp1 file] (which is '", 29u);
_Tchar_Pstdout_arr_2(_Lcp1_path_6, &_L_12);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_12, "') must not contain './'\n", 25u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_13, "Error, [cp1 file] (which is '", 29u);
_Tchar_Pstdout_arr_2(_Lcp1_path_6, &_L_13);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_13, "') must be a filename that ends with '.cp1', for example: main.cp1\n", 67u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_2, "Command was:", 12u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_4, "", 0u);
...
break_1:;
_NLibCp1_Pstdout_1(&_L_12);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_12, "Cannot execute '", 16u);
_Tchar_Pstdout_arr_2(_Lbin_0, &_L_12);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_12, " run' because the required compile was not found: tcc clang or gcc\n", 67u);
_NLibCp1_NStdOut_Pstdout_end_1(&_L_12);
exit(_NLibC_NExit_Cfailure);
}
void _Tchar_Poutput_2(char _Lval_0, struct _NCp1_NOutput* _Lo_1) {
...
break_0:;
_Ldata_5 = _NCp1_Pread_file_2(_Lcp1_path_0, &_Llen_6);
if(_Ldata_5 == NULL) {
struct _NLibCp1_NStdOut _L_7;
_NLibCp1_Pstdout_1(&_L_7);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_7, "Error, [cp1 file] (which is '", 29u);
_Tchar_Pstdout_arr_2(_Lcp1_path_0, &_L_7);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_7, "') cannot be opened for reading\n", 32u);
_NLibCp1_NStdOut_Pstdout_end_1(&_L_7);
return false;
}
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_8, "') must end a new line\n", 23u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_9, "') must have Unix line endings '\\n' instead of Windows line endings '\\r\\n'\n", 75u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_14, ": Error, use of tabs is discouraged, please use spaces instead\n", 63u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_18, "Error, cannot create a temporary file at the current folder\n", 60u);
...
_Ldata_5 = _NCp1_Pread_file_2(_Ltmp_path_dup_19, &_Llen_6);
if(_Ldata_5 == NULL) {
struct _NLibCp1_NStdOut _L_20;
_NLibCp1_Pstdout_1(&_L_20);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_20, "Error, cannot open file for reading: ", 37u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_25, ": Invalid character '", 21u);
_Tchar_Pstdout_2(_Ldata_5[_Lj_24], &_L_25);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_25, "' found in #include <...>\n", 26u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_28, ": #import \"...\" must end with '\"'\n", 34u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_31, ": #import \"", 11u);
_Tchar_Pstdout_arr_3(_Limport_29, &_L_31, _Limport_path_len_30);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_31, "\" doesn't need a '.cp1' suffix\n", 31u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_32, ": #import \"", 11u);
_Tchar_Pstdout_arr_3(_Limport_29, &_L_32, _Limport_path_len_30);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_32, "\" must be a relative path, '/' was detected at the beginning of file path\n", 74u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_34, ": #import \"", 11u);
_Tchar_Pstdout_arr_3(_Limport_29, &_L_34, _Limport_path_len_30);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_34, "\" must not contain backslashes '\\', please use forward slashes '/' instead\n", 75u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_36, ": #import \"", 11u);
_Tchar_Pstdout_arr_3(_Limport_29, &_L_36, _Limport_path_len_30);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_36, "\" must not contain './'\n", 24u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_38, "Error from #import \"", 20u);
_Tchar_Pstdout_arr_3(_Limport_29, &_L_38, _Limport_path_len_30 - 4);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_38, "\" at file '", 11u);
_Tchar_Pstdout_arr_2(_Lcp1_path_0, &_L_38);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_38, "' line ", 7u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_41, ": Invalid character '", 21u);
_Tchar_Pstdout_2(_Ldata_5[_Lj_40], &_L_41);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_41, "' found in #include <...>\n", 26u);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_44, ": #include <...> must end with '>'\n", 35u);
...
break_14:;
_Lspec_data_53 = _NCp1_Pread_file_2(_Lspec_path_51, &_Lspec_len_54);
...
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_55, ": #include <", 12u);
_Tchar_Pstdout_arr_2(_Lpath_50, &_L_55);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_55, "> failed because '", 18u);
_Tchar_Pstdout_arr_2(_Lspec_path_51, &_L_55);
_NLibCp1_NStdOut_Pstdout_cstr_3(&_L_55, "' does not exists\n", 18u);
