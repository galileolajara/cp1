...
syntax match Operator /@\(inline\|main\|case\|process\|real-name\|meta\|glc-name\|no-decl\|no-body\|decl\|extern\|var-args\|soa-field\|cp1-name\|fall-through\|reflection\|no-cache\)/
