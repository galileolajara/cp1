...
syntax match Operator /\(true\|false\|null\|return\|continue\|break\|using\|if\|elif\|else\|switch\|case\|default\|loop\|'ref\|'bool\|'char\|'intc\|'i8\|'u8\|'i16\|'u16\|'i32\|'u32\|'i64\|'u64\|'isz\|'usz\|'f32\|'f64\|'this\|enum\|struct\|union\|meta\|'base\)[a-zA-Z0-9-_]\@!/
