...
#define _Ncp1_Nbasic_type_id_Cu32 (_Ncp1_Nbasic_type_id_Ci32 + 1)
#define _Ncp1_Nbasic_type_id_Ci64 (_Ncp1_Nbasic_type_id_Cu32 + 1)
#define _Ncp1_Nbasic_type_id_Cu64 (_Ncp1_Nbasic_type_id_Ci64 + 1)
#define _Ncp1_Nbasic_type_id_Cisz (_Ncp1_Nbasic_type_id_Cu64 + 1)
...
#define _Ncp1_Nat_def_Cundefined 0
#define _Ncp1_Nat_def_Cmodule (_Ncp1_Nat_def_Cundefined + 1)
#define _Ncp1_Nat_def_Cstruct (_Ncp1_Nat_def_Cmodule + 1)
#define _Ncp1_Nat_def_Cenum (_Ncp1_Nat_def_Cstruct + 1)
...
#define _Ncp1_Ndecl_var_type_Cgvar 0
#define _Ncp1_Ndecl_var_type_Cfvar (_Ncp1_Ndecl_var_type_Cgvar + 1)
...
#define _Ncp1_Nlvar_flags_Cprocessed (2)
#define _Ncp1_Ngvar_flags_Cno_decl (1)
#define _Ncp1_Ngvar_flags_C0 0
...
typedef uint8_t _Ncp1_Ndecl_var_type;
...
struct _Ncp1_Nstmt_switch_case_func;
struct _Ncp1_Nstmt_switch_case_func {
_Ncp1_Ncvar _Fcvar;
_Ncp1_Nfunc _Ffunc;
};
...
struct _Ncp1_Nstmt_switch_case_func* _Fcase_func_v;
};
...
struct _Ncp1_Nfile_data* _Gfile_v;
...
struct _Ncp1_Nstmt_switch* _Gswitch_stack_v[64];
...
void _Ncp1_Nat_data_Pinit_4(struct _Ncp1_Nat_data* _Lat_0, _Ncp1_Nname_type _Ltype_1, _Ncp1_Nat _Lparent_2, _Ncp1_Nid _Lname_3);
...
struct _Ncp1_Nstruct_data* _Ncp1_Nstruct_Pptr_1(_Ncp1_Nstruct _Ls_0);
struct _Ncp1_Nenum_data* _Ncp1_Nenum_Pptr_1(_Ncp1_Nenum _Lf_0);
...
void _Ncp1_Ninclude_Poutput_1(_Ncp1_Ninclude _Lthis_0);
...
void _Ncp1_Nexpr_i_Pwrite_1(_Ncp1_Nexpr_i _Le_0);
void _Ncp1_Nat_Pwrite_1(_Ncp1_Nat _Lat_idx_0);
void _Ncp1_Nat_Pwrite_space_1(_Ncp1_Nat _Lat_idx_0);
void _Ncp1_Ndecl_var_data_Pwrite_type_2(struct _Ncp1_Ndecl_var_data* _Lvd_0, _Ncp1_Ndecl_var_type _Lvar_type_1);
struct _Ncp1_Ndecl_gvar* _Ncp1_Ngvar_Pptr_1(_Ncp1_Ngvar _Lg_0);
void _Ncp1_Ndecl_func_Pwrite_1(struct _Ncp1_Ndecl_func* _Lf_0);
bool _Ncp1_Nat_Pwrite_type_info_3(_Ncp1_Nat _Ltd_0, struct _Ncp1_Ntype_info* _Lti_1, int32_t _Ladd_2);
void _Ncp1_Ndecl_var_data_Pwrite_lvar_type_2(struct _Ncp1_Ndecl_var_data* _Lvd_0, _Ncp1_Nlvar _Llvar_1);
void _Ncp1_Nstmt_space_Pwrite_1(struct _Ncp1_Nstmt_space* _Lspace_0);
...
void _Ncp1_Nname_type_Prd_2(_Ncp1_Nname_type* _Li_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nbasic_type_id_Prd_2(_Ncp1_Nbasic_type_id* _Le_0, union _Ncp1_Nrdr* _Lr_1);
_Ncp1_Nat _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id _Lt_0);
...
void _Ncp1_Ndecl_var_data_Prd_2(struct _Ncp1_Ndecl_var_data* _Lvd_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Ncvar_flags_Prd_2(_Ncp1_Ncvar_flags* _Lf_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_2(_Ncp1_Nexpr_i* _Le_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Ncvar_Prd_2(_Ncp1_Ncvar* _Lc_0, union _Ncp1_Nrdr* _Lr_1);
#define _Ncp1_Pquick_alloc_one_1(r) r = qalloc(sizeof(r[0]))
void _Ncp1_Nenum_flags_Prd_2(_Ncp1_Nenum_flags* _Le_0, union _Ncp1_Nrdr* _Lr_1);
#define _Ncp1_Pquick_alloc_plus_2(r, plus) r = qalloc(sizeof(r[0]) + plus)
void _Ncp1_Nstruct_flags_Prd_2(_Ncp1_Nstruct_flags* _Lf_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nfarg_Prd_2(struct _Ncp1_Nfarg* _Lf_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nfunc_flags_Prd_2(_Ncp1_Nfunc_flags* _Le_0, union _Ncp1_Nrdr* _Lr_1);
...
struct _Ncp1_Nfile_data* _Ncp1_Nfile_Pptr_1(_Ncp1_Nfile _Lf_0);
...
bool _Ncp1_Nat_Pfinalize_4(_Ncp1_Nat _Lat_i_0, struct _Ncp1_Ntype_info* _Lti_1, int32_t _Lrow_2, int32_t _Lcol_3);
void _Ncp1_Ndecl_func_Plvars_rd_2(struct _Ncp1_Ndecl_func* _Lf_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_3(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1, struct _Ncp1_Nstmt_space* _Lparent_2);
...
bool _Ncp1_Nexpr_i_Pprocess_1(_Ncp1_Nexpr_i _Le_0);
char* _Ncp1_Nid_Pc_name_1(_Ncp1_Nid _Lid_0);
struct _Ncp1_Nexpr* _Ncp1_Nexpr_i_Pptr_1(_Ncp1_Nexpr_i _Le_0);
void _Ncp1_Nexpr_i_Pwrite_assign_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_compare_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_bool_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_char_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_math_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_unary_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_ref_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_lvar_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_fvar_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_gvar_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_cvar_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_bools_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_method_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_func_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_str_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_i32_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_size_of_type_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_null_1(struct _Ncp1_Nexpr* _Lexpr_0);
void _Ncp1_Nexpr_i_Pwrite_index_1(struct _Ncp1_Nexpr* _Lexpr_0);
...
void _Ncp1_Ndecl_var_data_Pwrite_2(struct _Ncp1_Ndecl_var_data* _Lvd_0, _Ncp1_Ndecl_var_type _Lvar_type_1);
bool _Ncp1_Nexpr_i_Pwrite_value_2(_Ncp1_Nexpr_i _Le_0, struct _Ncp1_Nvalue* _Lv_1);
void _Ncp1_Ntype_info_Pcount_1(struct _Ncp1_Ntype_info* _Lti_0);
bool _Ncp1_Nat_Pwrite_type_1(_Ncp1_Nat _Ltd_0);
int32_t _Ncp1_Nat_Pcount_stars0_2(_Ncp1_Nat _Ltd_0, struct _Ncp1_Ntype_info* _Lti_1);
size_t _Nstdc_Nfile_Pwrite_3(struct FILE* _Lf_0, void* _Lbuf_1, size_t _Lsize_2);
void _Ncp1_Ndecl_var_data_Pwrite_lvar_2(struct _Ncp1_Ndecl_var_data* _Lvd_0, _Ncp1_Nlvar _Llvar_1);
struct _Ncp1_Nlvar_data* _Ncp1_Nlvar_Pptr_1(_Ncp1_Nlvar _Ll_0);
void _Ncp1_Nstmt_Pwrite_1(struct _Ncp1_Nstmt* _Ls_0);
void _Ncp1_Nvar_flags_Prd_2(_Ncp1_Nvar_flags* _Lf_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Ntype_info_Prd_2(struct _Ncp1_Ntype_info* _Lti_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_type_Prd_2(_Ncp1_Nexpr_type* _Le_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_assign_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_compare_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_bool_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_char_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_math_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_unary_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_ref_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_cast_fast_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_lvar_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_fvar_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_gvar_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_cvar_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_bools_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_method_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_func_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_str_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_i32_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_size_of_type_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_null_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nexpr_i_Prd_index_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nlvar_flags_Prd_2(_Ncp1_Nlvar_flags* _Lf_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nlvar_Prd_2(_Ncp1_Nlvar* _Ll_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_type_Prd_2(_Ncp1_Nstmt_type* _Ls_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_expr_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_if_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_if_elif_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_if_else_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_if_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_switch_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_case_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_case_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_default_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_default_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_switch_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_do_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_do_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_while_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_while_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_continue_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_break_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_return_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
void _Ncp1_Nstmt_space_Prd_space_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1);
...
bool _Ncp1_Ndecl_var_data_Pprocess_5(struct _Ncp1_Ndecl_var_data* _Lvd_0, _Ncp1_Nfile _Lfile_1, int32_t _Lrow_2, int32_t _Lcol_3, _Ncp1_Nat _Lbase_at_4);
void _Ncp1_Nexpr_i_Pprocess_assign_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_compare_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_bool_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_char_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_math_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_unary_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_ref_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_cast_fast_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_lvar_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_fvar_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_gvar_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_cvar_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_bools_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_method_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_func_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_str_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_i32_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_size_of_type_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_null_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
void _Ncp1_Nexpr_i_Pprocess_index_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1);
...
void _Ncp1_Nexpr_cast_fast_Pwrite_value_2(struct _Ncp1_Nexpr_cast_fast* _Le_0, struct _Ncp1_Nvalue* _Lv_1);
...
void _Ncp1_Nexpr_i_Pset_3(_Ncp1_Nexpr_i _Le_0, struct _Ncp1_Nexpr* _Lexpr_1, _Ncp1_Nexpr_type _Ltype_2);
...
void _Ncp1_Nstmt_space_Pstmt_push_7(struct _Ncp1_Nstmt_space* _Ls_0, struct _Ncp1_Nstmt* _Ls2_1, int32_t _Lbegin_row_2, int32_t _Lbegin_col_3, int32_t _Lend_row_4, int32_t _Lend_col_5, _Ncp1_Nstmt_type _Ltype_6);
bool _Ncp1_Nexpr_i_Pvalue_4(_Ncp1_Nexpr_i _Le_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3);
bool _Ncp1_Nexpr_i_Pprocess_case_func_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nfunc _Lf_idx_1);
uint8_t _Ncp1_Nid_Plen_1(_Ncp1_Nid _Lid_0);
bool _Ncp1_Nstmt_space_Pprocess_1(struct _Ncp1_Nstmt_space* _Lspace_0);
void _Ncp1_Nexpr_i_Ptry_deduce_2(_Ncp1_Nexpr_i _Le_idx_0, _Ncp1_Nat _Lat_1);
...
_Ncp1_Nat _Ncp1_Nexpr_i_Ptype_1(_Ncp1_Nexpr_i _Le_0);
bool _Ncp1_Nlvar_Pprocess_1(_Ncp1_Nlvar _Ll_0);
bool _Ncp1_Ngvar_Pprocess_1(_Ncp1_Ngvar _Lg_0);
bool _Ncp1_Pfarg_process_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lca_ref_1, struct _Ncp1_Nvalue* _Lca_value_2, struct _Ncp1_Ndecl_var_data* _Lfd_arg_3, _Ncp1_Nat _Lbase_at_4);
void _Ncp1_Nexpr_i_Pvalue_assign_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_compare_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_bool_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_char_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_math_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_unary_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_ref_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_cast_fast_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_lvar_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_fvar_5(_Ncp1_Nexpr_i _Lexpr_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_gvar_5(_Ncp1_Nexpr_i _Lg_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_cvar_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_bools_5(_Ncp1_Nexpr_i _Le_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_func_5(_Ncp1_Nexpr_i _Le_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_method_5(_Ncp1_Nexpr_i _Le_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_str_5(_Ncp1_Nexpr_i _Ls_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_i32_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_size_of_type_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_null_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Pvalue_index_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4);
void _Ncp1_Nexpr_i_Ptry_deduce_math_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat _Lat_1);
void _Ncp1_Nexpr_i_Ptry_deduce_cvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat _Lat_1);
void _Ncp1_Nexpr_i_Ptype_assign_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_compare_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_bool_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_char_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_math_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_unary_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_ref_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_cast_fast_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_lvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_fvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_gvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_cvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_bools_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_func_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_method_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_i32_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
void _Ncp1_Nexpr_i_Ptype_size_of_type_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1);
...
_Ncp1_Nbasic_type_id _Ltype_2;
_Ltype_2 = (_Ncp1_Nbasic_type_id)(0);
...
_Ncp1_Nat_data_Pinit_4(_Lat_5, _Ncp1_Nname_type_Cbasic, _Ncp1_Nat_Croot, (_Ncp1_Nid)(_Ltype_2));
continue_0:;
_Ltype_2++;
}
break_0:;
...
if((*_Lat_10)._Ftype == _Ncp1_Nname_type_Cstruct_enum) {
...
if((*_Lat_10)._Fdef == _Ncp1_Nat_def_Cstruct) {
struct _Ncp1_Nstruct_data* _Lt_11;
...
} else if((*_Lat_10)._Fdef == _Ncp1_Nat_def_Cenum) {
struct _Ncp1_Nenum_data* _Lt_14;
...
} else if((*_Lat_10)._Ftype == _Ncp1_Nname_type_Cbasic) {
struct _Ncp1_Nbasic_type* _Lt_17;
...
_Gprocess_last = _Ncp1_Nfunc_Cnil;
while(1) {
struct _Ncp1_Ndecl_func* _Lf_28;
...
struct _Ncp1_Ndecl_func* _Lf_31;
int32_t _Lrow_32;
int32_t _Lcol_33;
...
if((*_Lf_31)._Fdecl._Ftype != _Ncp1_Nat_Cnil) {
_Ncp1_Nat_Poutput_4((*_Lf_31)._Fdecl._Ftype, (*_Lf_31)._Ffile, _Lrow_32, _Lcol_33);
}
int32_t _Li_34;
_Li_34 = 0;
for(int i = (*_Lf_31)._Ffarg_c; i > 0; ) {
i --;
_Ncp1_Nat_Poutput_4((*_Lf_31)._Ffarg_v[_Li_34]._Fdecl._Ftype, (*_Lf_31)._Ffile, _Lrow_32, _Lcol_33);
continue_6:;
_Li_34++;
}
break_6:;
if((*_Lf_31)._Finclude != _Ncp1_Ninclude_Cnil) {
_Ncp1_Ninclude_Poutput_1((*_Lf_31)._Finclude);
}
if(((*_Lf_31)._Fflags & _Ncp1_Nfunc_flags_Ccp1_name) != _Ncp1_Nfunc_flags_C0) {
struct _Ncp1_Nat_data* _Lat_35;
_Lat_35 = _Ncp1_Nat_Pptr_1((*_Lf_31)._Fat);
int32_t _Li_36;
_Ncp1_Ncvar* _Lv_37;
_Li_36 = 0;
...
i --;
_Ncp1_Ncvar _Lcvar_38;
_Lcvar_38 = _Lv_37[_Li_36];
if(((*_Ncp1_Ncvar_Pptr_1(_Lcvar_38))._Fflags & _Ncp1_Ncvar_flags_Cas_enum) != _Ncp1_Ncvar_flags_C0) {
_Ncp1_Ncvar_Pprocess_1(_Lcvar_38);
}
continue_7:;
_Li_36++;
}
...
i --;
_Ncp1_Ncvar _Lc_i_42;
struct _Ncp1_Ncvar_data* _Lc_43;
_Lc_i_42 = _Gcvar_outputted_v[_Li_41];
_Lc_43 = _Ncp1_Ncvar_Pptr_1(_Lc_i_42);
if(((*_Lc_43)._Fdecl._Fflags & _Ncp1_Nvar_flags_Cno_decl) != _Ncp1_Nvar_flags_C0) {
goto continue_9;
}
fprintf(_Gout, "#define ");
_Ncp1_Ncvar_Pwrite_1(_Lc_i_42);
fprintf(_Gout, " ");
if(((*_Lc_43)._Fflags & _Ncp1_Ncvar_flags_Cset_expr) != _Ncp1_Ncvar_flags_C0) {
fprintf(_Gout, "(");
_Ncp1_Nexpr_i_Pwrite_1((*_Lc_43)._Fexpr_set);
fprintf(_Gout, ")");
} else if((*_Lc_43)._Flast_cvar != _Ncp1_Ncvar_Cnil) {
fprintf(_Gout, "(");
_Ncp1_Ncvar_Pwrite_1((*_Lc_43)._Flast_cvar);
fprintf(_Gout, " + 1)");
} else {
fprintf(_Gout, "0");
}
...
i --;
_Ncp1_Nenum _Le_i_45;
struct _Ncp1_Nenum_data* _Le_46;
_Le_i_45 = _Genum_outputted_v[_Li_44];
_Le_46 = _Ncp1_Nenum_Pptr_1(_Le_i_45);
fprintf(_Gout, "typedef ");
_Ncp1_Nat_Pwrite_1((*_Le_46)._Fbase_type);
fprintf(_Gout, " ");
_Ncp1_Nat_Pwrite_1((*_Le_46)._Fat);
fprintf(_Gout, ";\n");
continue_10:;
_Li_44++;
}
...
i --;
_Ncp1_Nstruct _Ls_i_48;
struct _Ncp1_Nstruct_data* _Ls_49;
_Ls_i_48 = _Gstruct_outputted_v[_Li_47];
_Ls_49 = _Ncp1_Nstruct_Pptr_1(_Ls_i_48);
if(((*_Ls_49)._Fflags & _Ncp1_Nstruct_flags_Cunion) != _Ncp1_Nstruct_flags_C0) {
fprintf(_Gout, "union ");
} else {
fprintf(_Gout, "struct ");
}
_Ncp1_Nat_Pwrite_space_1((*_Ls_49)._Fat);
if(((*_Ls_49)._Fflags & _Ncp1_Nstruct_flags_Cunion) != _Ncp1_Nstruct_flags_C0) {
fprintf(_Gout, ";\nunion ");
} else {
fprintf(_Gout, ";\nstruct ");
...
i --;
struct _Ncp1_Nfvar_data* _Lfvar_51;
_Lfvar_51 = (&(*_Ls_49)._Ffvar_v[_Lj_50]);
_Ncp1_Ndecl_var_data_Pwrite_type_2(&(*_Lfvar_51)._Fdecl, _Ncp1_Ndecl_var_type_Cfvar);
fprintf(_Gout, ";\n");
continue_12:;
_Lj_50++;
}
...
i --;
_Ncp1_Ngvar _Lg_i_53;
struct _Ncp1_Ndecl_gvar* _Lg_54;
_Lg_i_53 = _Ggvar_outputted_v[_Li_52];
_Lg_54 = _Ncp1_Ngvar_Pptr_1(_Lg_i_53);
if(((*_Lg_54)._Fdecl._Fflags & _Ncp1_Nvar_flags_Cno_decl) != _Ncp1_Nvar_flags_C0) {
goto continue_13;
}
if(((*_Lg_54)._Fdecl._Fflags & _Ncp1_Nvar_flags_Cextern) != _Ncp1_Nvar_flags_C0) {
fprintf(_Gout, "extern ");
}
_Ncp1_Ndecl_var_data_Pwrite_type_2(&(*_Lg_54)._Fdecl, _Ncp1_Ndecl_var_type_Cgvar);
fprintf(_Gout, ";\n");
continue_13:;
_Li_52++;
}
...
for(int i = _Gfunc_head_outputted_c; i > 0; ) {
i --;
_Ncp1_Nfunc _Lf_idx_56;
struct _Ncp1_Ndecl_func* _Lf_57;
_Lf_idx_56 = _Gfunc_head_outputted_v[_Li_55];
_Lf_57 = _Ncp1_Nfunc_Pptr_1(_Lf_idx_56);
if(((*_Lf_57)._Fflags & _Ncp1_Nfunc_flags_Cno_decl) != _Ncp1_Nfunc_flags_C0) {
goto continue_14;
}
if(((*_Lf_57)._Fflags & _Ncp1_Nfunc_flags_Cdecl) != _Ncp1_Nfunc_flags_C0) {
if((((*_Lf_57)._Fdecl_str[0] == '#') && ((*_Lf_57)._Fdecl_str[1] == ' '))) {
fprintf(_Gout, "#define ");
_Ncp1_Ndecl_func_Pwrite_1(_Lf_57);
fprintf(_Gout, "(");
int32_t _Lj_58;
_Lj_58 = 0;
...
fprintf(_Gout, "%s", _Ncp1_Nid_Pstr_1((*_Lf_57)._Ffarg_v[_Lj_58]._Fdecl._Fname));
continue_15:;
_Lj_58++;
}
break_15:;
...
_Gctx_func = _Lf_57;
if((*_Lf_57)._Fdecl._Ftype == _Ncp1_Nat_Cnil) {
fprintf(_Gout, "void");
} else {
_Ncp1_Nat_Pwrite_type_info_3((*_Lf_57)._Fdecl._Ftype, &(*_Lf_57)._Fdecl._Ftype_info, 0);
}
fprintf(_Gout, " ");
_Ncp1_Ndecl_func_Pwrite_1(_Lf_57);
fprintf(_Gout, "(");
...
_Ncp1_Ndecl_var_data_Pwrite_lvar_type_2(&(*_Lf_57)._Ffarg_v[_Lj_59]._Fdecl, (_Ncp1_Nlvar)(_Lj_59));
continue_16:;
_Lj_59++;
}
break_16:;
if(((*_Lf_57)._Fflags & _Ncp1_Nfunc_flags_Ccp1_name) != _Ncp1_Nfunc_flags_C0) {
struct _Ncp1_Nat_data* _Lat_60;
fprintf(_Gout, ") {\nswitch(_Le_0) {\n");
_Lat_60 = _Ncp1_Nat_Pptr_1((*_Lf_57)._Fat);
int32_t _Li_61;
_Ncp1_Ncvar* _Lv_62;
_Li_61 = 0;
...
i --;
_Ncp1_Ncvar _Lcvar_i_63;
struct _Ncp1_Ncvar_data* _Lcvar_64;
_Lcvar_i_63 = _Lv_62[_Li_61];
_Lcvar_64 = _Ncp1_Ncvar_Pptr_1(_Lcvar_i_63);
if(((*_Lcvar_64)._Fflags & _Ncp1_Ncvar_flags_Cas_enum) == _Ncp1_Ncvar_flags_C0) {
goto continue_17;
}
fprintf(_Gout, "case ");
_Ncp1_Ncvar_Pwrite_1(_Lcvar_i_63);
fprintf(_Gout, ": return \"%s\";\n", _Ncp1_Nid_Pstr_1((*_Lcvar_64)._Fdecl._Fname));
continue_17:;
_Li_61++;
}
break_17:;
...
i --;
_Ncp1_Nfunc _Lf_idx_66;
struct _Ncp1_Ndecl_func* _Lf_67;
_Lf_idx_66 = _Gfunc_body_outputted_v[_Li_65];
_Lf_67 = _Ncp1_Nfunc_Pptr_1(_Lf_idx_66);
_Gctx_func = _Lf_67;
_Gnest_id = 0;
if((*_Lf_67)._Fflags & _Ncp1_Nfunc_flags_Cinline) {
fprintf(_Gout, "inline ");
}
if((*_Lf_67)._Fdecl._Ftype == _Ncp1_Nat_Cnil) {
fprintf(_Gout, "void");
} else {
_Ncp1_Nat_Pwrite_type_info_3((*_Lf_67)._Fdecl._Ftype, &(*_Lf_67)._Fdecl._Ftype_info, 0);
}
fprintf(_Gout, " ");
_Ncp1_Ndecl_func_Pwrite_1(_Lf_67);
fprintf(_Gout, "(");
int32_t _Lj_68;
_Lj_68 = 0;
...
_Ncp1_Ndecl_var_data_Pwrite_lvar_type_2(&(*_Lf_67)._Ffarg_v[_Lj_68]._Fdecl, (_Ncp1_Nlvar)(_Lj_68));
continue_19:;
_Lj_68++;
}
break_19:;
fprintf(_Gout, ") {\n");
_Ncp1_Nstmt_space_Pwrite_1(&(*_Lf_67)._Fstmt_space);
fprintf(_Gout, "}\n");
continue_18:;
_Li_65++;
}
...
(*_Lat_0)._Fdef = _Ncp1_Nat_def_Cundefined;
}
void _Ncp1_Pread_1(char* _Lin_path_0) {
...
struct _Ncp1_Nfile_data* _Lfile_6;
...
i --;
_Ncp1_Nname_type_Prd_2(&_Lat_type_21, &_Lr_7);
if(_Lat_type_21 == _Ncp1_Nname_type_Cbasic) {
_Ncp1_Nbasic_type_id _Lbasic_23;
_Ncp1_Nbasic_type_id_Prd_2(&_Lbasic_23, &_Lr_7);
...
_Lfound_26 = _Ncp1_Nat_map_Pget_or_insert_5(&_Gat_map, _Lat_parent_24, _Lat_type_21, _Lat_name_25, _Gat_c);
if(_Lfound_26 == -1) {
_Ncp1_Nat _Lat_idx_27;
struct _Ncp1_Nat_data* _Lat_29;
_Lat_idx_27 = _Gat_c++;
if(_Gat_cap <= _Gat_c) {
...
_Ncp1_Nat_data_Pinit_4(_Lat_29, _Lat_type_21, _Lat_parent_24, _Lat_name_25);
...
i --;
struct _Ncp1_Ncvar_data* _Lcvar_35;
struct _Ncp1_Nat_data* _Lat_36;
...
_Ncp1_Ndecl_var_data_Prd_2(&(*_Lcvar_35)._Fdecl, &_Lr_7);
_Ncp1_Ncvar_flags_Prd_2(&(*_Lcvar_35)._Fflags, &_Lr_7);
...
if(((*_Lcvar_35)._Fflags & _Ncp1_Ncvar_flags_Cset_expr) != _Ncp1_Ncvar_flags_C0) {
_Ncp1_Nexpr_i_Prd_2(&(*_Lcvar_35)._Fexpr_set, &_Lr_7);
} else {
...
i --;
struct _Ncp1_Ndecl_gvar* _Lgvar_44;
...
_Ncp1_Ndecl_var_data_Prd_2(&(*_Lgvar_44)._Fdecl, &_Lr_7);
...
i --;
struct _Ncp1_Nenum_data* _Le_52;
_Ncp1_Nat _Lat_i_53;
...
_Ncp1_Nenum_flags_Prd_2(&(*_Le_52)._Fflags, &_Lr_7);
_Lat_i_53 = (*_Le_52)._Fat;
_Lat_54 = _Ncp1_Nat_Pptr_1(_Lat_i_53);
if((*_Lat_54)._Fdef != _Ncp1_Nat_def_Cundefined) {
fprintf(stdout, "Cannot define struct :%s because it was already defined as ", _Ncp1_Nid_Pstr_1((*_Lat_54)._Fname._Fid));
if((*_Lat_54)._Fdef == _Ncp1_Nat_def_Cstruct) {
fprintf(stdout, "struct\n");
}
}
(*_Lat_54)._Fdecl._Fenum = _Le_idx_51;
(*_Lat_54)._Fdef = _Ncp1_Nat_def_Cenum;
if(((*_Le_52)._Fflags & _Ncp1_Nenum_flags_Creal_name) != _Ncp1_Nenum_flags_C0) {
...
i --;
uint8_t _Lfvar_c_59;
struct _Ncp1_Nstruct_data* _Ls_60;
_Ncp1_Nat _Lat_i_61;
struct _Ncp1_Nat_data* _Lat_62;
_Lfvar_c_59 = _Ncp1_Nrdr_Pn1_1(&_Lr_7);
_Ncp1_Pquick_alloc_plus_2(_Ls_60, sizeof(struct _Ncp1_Nfvar_data) * _Lfvar_c_59);
...
_Ncp1_Nstruct_flags_Prd_2(&(*_Ls_60)._Fflags, &_Lr_7);
_Lat_i_61 = (*_Ls_60)._Fat;
_Lat_62 = _Ncp1_Nat_Pptr_1(_Lat_i_61);
if((*_Lat_62)._Fdef != _Ncp1_Nat_def_Cundefined) {
fprintf(stdout, "Cannot define struct :%s because it was already defined as ", _Ncp1_Nid_Pstr_1((*_Lat_62)._Fname._Fid));
if((*_Lat_62)._Fdef == _Ncp1_Nat_def_Cenum) {
fprintf(stdout, "enum\n");
}
}
(*_Lat_62)._Fdecl._Fstruct = _Ls_idx_58;
(*_Lat_62)._Fdef = _Ncp1_Nat_def_Cstruct;
int32_t _Lj_63;
_Lj_63 = 0;
for(int i = _Lfvar_c_59; i > 0; ) {
i --;
struct _Ncp1_Nfvar_data* _Lfvar_64;
_Lfvar_64 = (&(*_Ls_60)._Ffvar_v[_Lj_63]);
_Ncp1_Ndecl_var_data_Prd_2(&(*_Lfvar_64)._Fdecl, &_Lr_7);
continue_7:;
_Lj_63++;
}
break_7:;
if(((*_Ls_60)._Fflags & _Ncp1_Nstruct_flags_Creal_name) != _Ncp1_Nstruct_flags_C0) {
...
_Ncp1_Ndecl_var_data_Prd_2(&(*_Lf_70)._Fdecl, &_Lr_7);
...
break_10:;
_Ncp1_Nfunc_flags_Prd_2(&(*_Lf_70)._Fflags, &_Lr_7);
if(((*_Lf_70)._Fflags & _Ncp1_Nfunc_flags_Creal_name) != _Ncp1_Nfunc_flags_C0) {
...
if(_Gfunc_main != _Ncp1_Nfunc_Cnil) {
struct _Ncp1_Ndecl_func* _Lfirst_83;
struct _Ncp1_Ndecl_func* _Lsecond_84;
...
for(int i = _Lfunc_c_65; i > 0; ) {
i --;
struct _Ncp1_Ndecl_func* _Lf_86;
uint32_t _Lsize_87;
_Lf_86 = _Gfunc_v[_Lf_idx_85];
if(((*_Lf_86)._Fflags & _Ncp1_Nfunc_flags_Chas_body) == _Ncp1_Nfunc_flags_C0) {
goto continue_11;
}
...
inline struct _Ncp1_Nstruct_data* _Ncp1_Nstruct_Pptr_1(_Ncp1_Nstruct _Ls_0) {
return _Gstruct_v[_Ls_0];
}
inline struct _Ncp1_Nenum_data* _Ncp1_Nenum_Pptr_1(_Ncp1_Nenum _Lf_0) {
...
if(((*_Lf_4)._Fflags & _Ncp1_Nfunc_flags_Chas_body) != _Ncp1_Nfunc_flags_C0) {
...
struct _Ncp1_Ndecl_func* _Lf_last_10;
...
bool _Ncp1_Nfunc_Pprocess_now_1(_Ncp1_Nfunc _Lf_idx_0) {
struct _Ncp1_Ndecl_func* _Lf_1;
union _Ncp1_Nrdr _Lr_2;
struct _Ncp1_Nfile_data* _Lfile_3;
...
_Ncp1_Ndecl_func_Plvars_rd_2(_Lf_1, &_Lr_2);
_Ncp1_Nstmt_space_Prd_3(&(*_Lf_1)._Fstmt_space, &_Lr_2, NULL);
...
break_0:;
if(((*_Lf_1)._Fflags & _Ncp1_Nfunc_flags_Cno_body) == _Ncp1_Nfunc_flags_C0) {
_Gfunc_body_outputted_v[_Gfunc_body_outputted_c++] = _Lf_idx_0;
}
return true;
}
void _Ncp1_Nat_Poutput_4(_Ncp1_Nat _Lat_i_0, _Ncp1_Nfile _Lfile_1, int32_t _Lrow_2, int32_t _Lcol_3) {
struct _Ncp1_Nat_data* _Lat_4;
_Lat_4 = _Ncp1_Nat_Pptr_1(_Lat_i_0);
switch((*_Lat_4)._Ftype) {
case _Ncp1_Nname_type_Cstruct_enum:;
if((*_Lat_4)._Fdef == _Ncp1_Nat_def_Cstruct) {
...
} else if((*_Lat_4)._Fdef == _Ncp1_Nat_def_Cenum) {
...
break;
case _Ncp1_Nname_type_Cbasic:;
switch((*_Lat_4)._Fname._Fbasic) {
case _Ncp1_Nbasic_type_id_Cbool:;
...
inline void _Ncp1_Ninclude_Poutput_1(_Ncp1_Ninclude _Lthis_0) {
uint32_t _Lnum_1;
uint32_t _Ln3_2;
int32_t _Ln17_3;
...
uint32_t _Ln3_2;
int32_t _Ln17_3;
struct _Ncp1_Ncvar_data* _Lcvar_4;
_Ncp1_Nat _Lat_i_5;
...
if(((*_Lcvar_4)._Fflags & _Ncp1_Ncvar_flags_Cset_expr) != _Ncp1_Ncvar_flags_C0) {
if(!(_Ncp1_Nexpr_i_Pprocess_1((*_Lcvar_4)._Fexpr_set))) {
return false;
}
...
if((((*_Lat_6)._Ftype != _Ncp1_Nname_type_Cbasic) && ((*_Lat_6)._Fdecl._Fstruct == _Ncp1_Nstruct_Cnil))) {
...
struct _Ncp1_Ncvar_data* _Lcvar_1;
_Lcvar_1 = _Ncp1_Ncvar_Pptr_1(_Lc_0);
if(((*_Lcvar_1)._Fdecl._Fflags & _Ncp1_Nvar_flags_Creal_name) != _Ncp1_Nvar_flags_C0) {
...
_Lexpr_1 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
switch((*_Lexpr_1)._Ftype) {
case _Ncp1_Nexpr_type_Cassign:;
_Ncp1_Nexpr_i_Pwrite_assign_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Ccompare:;
_Ncp1_Nexpr_i_Pwrite_compare_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cbool:;
_Ncp1_Nexpr_i_Pwrite_bool_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cchar:;
_Ncp1_Nexpr_i_Pwrite_char_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cmath:;
_Ncp1_Nexpr_i_Pwrite_math_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cunary:;
_Ncp1_Nexpr_i_Pwrite_unary_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cref:;
_Ncp1_Nexpr_i_Pwrite_ref_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Clvar:;
_Ncp1_Nexpr_i_Pwrite_lvar_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cfvar:;
_Ncp1_Nexpr_i_Pwrite_fvar_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cgvar:;
_Ncp1_Nexpr_i_Pwrite_gvar_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Ccvar:;
_Ncp1_Nexpr_i_Pwrite_cvar_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cbools:;
_Ncp1_Nexpr_i_Pwrite_bools_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cmethod:;
_Ncp1_Nexpr_i_Pwrite_method_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cfunc:;
_Ncp1_Nexpr_i_Pwrite_func_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cstr:;
_Ncp1_Nexpr_i_Pwrite_str_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Ci32:;
_Ncp1_Nexpr_i_Pwrite_i32_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Csize_of_type:;
_Ncp1_Nexpr_i_Pwrite_size_of_type_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cnull:;
_Ncp1_Nexpr_i_Pwrite_null_1(_Lexpr_1);
break;
case _Ncp1_Nexpr_type_Cindex:;
_Ncp1_Nexpr_i_Pwrite_index_1(_Lexpr_1);
break;
default:;
fprintf(stdout, "%s:%u:%u - %u:%u: write() not implemented in expression #%s\n", _Ncp1_Nfile_Ppath_1((*_Gctx_func)._Ffile), _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nexpr_type_Pcp1_name_1((*_Lexpr_1)._Ftype));
break;
}
}
void _Ncp1_Nat_Pwrite_1(_Ncp1_Nat _Lat_idx_0) {
...
break;
case _Ncp1_Nname_type_Cstruct_enum:;
if((*_Lat_1)._Fdef == _Ncp1_Nat_def_Cstruct) {
_Ncp1_Nstruct _Lt_idx_2;
struct _Ncp1_Nstruct_data* _Lt_3;
_Lt_idx_2 = (*_Lat_1)._Fdecl._Fstruct;
_Lt_3 = _Ncp1_Nstruct_Pptr_1(_Lt_idx_2);
if(_Lt_idx_2 != _Ncp1_Nstruct_Cnil) {
if(((*_Lt_3)._Fflags & _Ncp1_Nstruct_flags_Creal_name) != _Ncp1_Nstruct_flags_C0) {
if((*_Lt_3)._Freal_name == _Ncp1_Nid_Cnil) {
if(((*_Lt_3)._Fflags & _Ncp1_Nstruct_flags_Cunion) != _Ncp1_Nstruct_flags_C0) {
...
} else if((*_Lat_1)._Fdef == _Ncp1_Nat_def_Cenum) {
_Ncp1_Nenum _Lt_idx_4;
_Lt_idx_4 = (*_Lat_1)._Fdecl._Fenum;
if(_Lt_idx_4 != _Ncp1_Nenum_Cnil) {
struct _Ncp1_Nenum_data* _Lt_5;
_Lt_5 = _Ncp1_Nenum_Pptr_1(_Lt_idx_4);
if(((*_Lt_5)._Fflags & _Ncp1_Nenum_flags_Creal_name) != _Ncp1_Nenum_flags_C0) {
...
case _Ncp1_Nbasic_type_id_Cref:;
fprintf(_Gout, "void*");
break;
case _Ncp1_Nbasic_type_id_Cbool:;
fprintf(_Gout, "bool");
break;
case _Ncp1_Nbasic_type_id_Cchar:;
fprintf(_Gout, "char");
break;
case _Ncp1_Nbasic_type_id_Cintc:;
fprintf(_Gout, "int");
break;
case _Ncp1_Nbasic_type_id_Ci8:;
...
break;
case _Ncp1_Nbasic_type_id_Cisz:;
fprintf(_Gout, "ssize_t");
break;
case _Ncp1_Nbasic_type_id_Cusz:;
fprintf(_Gout, "size_t");
break;
case _Ncp1_Nbasic_type_id_Cf32:;
fprintf(_Gout, "float");
break;
case _Ncp1_Nbasic_type_id_Cf64:;
...
fprintf(_Gout, " ");
_Ncp1_Ndecl_var_data_Pwrite_2(_Lvd_0, _Lvar_type_1);
int32_t _Li_2;
_Li_2 = 0;
for(int i = (*_Lvd_0)._Fsize_c; i > 0; ) {
i --;
fprintf(_Gout, "[");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Lvd_0)._Fsize_expr_v[_Li_2], &(*_Lvd_0)._Fsize_value_v[_Li_2]);
fprintf(_Gout, "]");
continue_0:;
_Li_2++;
}
...
inline struct _Ncp1_Ndecl_gvar* _Ncp1_Ngvar_Pptr_1(_Ncp1_Ngvar _Lg_0) {
return &_Ggvar_v[_Lg_0];
}
void _Ncp1_Ndecl_func_Pwrite_1(struct _Ncp1_Ndecl_func* _Lf_0) {
if(((*_Lf_0)._Fflags & _Ncp1_Nfunc_flags_Creal_name) != _Ncp1_Nfunc_flags_C0) {
...
bool _Ncp1_Nat_Pwrite_type_info_3(_Ncp1_Nat _Ltd_0, struct _Ncp1_Ntype_info* _Lti_1, int32_t _Ladd_2) {
int32_t _Ls_3;
_Ncp1_Ntype_info_Pcount_1(_Lti_1);
...
_Ncp1_Nat_Pwrite_type_info_3((*_Lvd_0)._Ftype, &(*_Lvd_0)._Ftype_info, 0 - (*_Lvd_0)._Fsize_c);
fprintf(_Gout, " ");
_Ncp1_Ndecl_var_data_Pwrite_lvar_2(_Lvd_0, _Llvar_1);
int32_t _Li_2;
_Li_2 = 0;
for(int i = (*_Lvd_0)._Fsize_c; i > 0; ) {
i --;
...
struct _Ncp1_Nlvar_data* _Llvar_4;
_Llvar_i_3 = (*_Lspace_0)._Flvar_v[_Li_1];
_Llvar_4 = _Ncp1_Nlvar_Pptr_1(_Llvar_i_3);
_Ncp1_Ndecl_var_data_Pwrite_lvar_type_2(&(*_Llvar_4)._Fdecl, _Llvar_i_3);
if(((*_Llvar_4)._Fflags & _Ncp1_Nlvar_flags_Cset_expr) != _Ncp1_Nlvar_flags_C0) {
fprintf(_Gout, " = ");
_Ncp1_Nexpr_i_Pwrite_1((*_Llvar_4)._Fset_expr);
}
fprintf(_Gout, ";\n");
continue_0:;
_Li_1++;
...
inline void _Ncp1_Nname_type_Prd_2(_Ncp1_Nname_type* _Li_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Li_0) = (_Ncp1_Nname_type)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
}
inline void _Ncp1_Nbasic_type_id_Prd_2(_Ncp1_Nbasic_type_id* _Le_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Le_0) = (_Ncp1_Nbasic_type_id)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
}
inline _Ncp1_Nat _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id _Lt_0) {
return _Lt_0;
}
...
for(int i = (*_Lvd_0)._Fsize_c; i > 0; ) {
i --;
_Ncp1_Nexpr_i_Prd_2(&(*_Lvd_0)._Fsize_expr_v[_Li_2], _Lr_1);
continue_0:;
_Li_2++;
}
break_0:;
...
inline void _Ncp1_Ncvar_flags_Prd_2(_Ncp1_Ncvar_flags* _Lf_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Lf_0) = (_Ncp1_Ncvar_flags)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
}
void _Ncp1_Nexpr_i_Prd_2(_Ncp1_Nexpr_i* _Le_0, union _Ncp1_Nrdr* _Lr_1) {
_Ncp1_Nexpr_type _Ltype_2;
...
_Ncp1_Nexpr_type_Prd_2(&_Ltype_2, _Lr_1);
if(_Ltype_2 == _Ncp1_Nexpr_type_Cnil) {
(*_Le_0) = _Ncp1_Nexpr_i_Cnil;
} else {
_Ncp1_Nexpr_i _Le_idx_3;
_Le_idx_3 = (_Ncp1_Nexpr_i)(_Gexpr_c++);
...
switch(_Ltype_2) {
case _Ncp1_Nexpr_type_Cassign:;
_Ncp1_Nexpr_i_Prd_assign_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Ccompare:;
_Ncp1_Nexpr_i_Prd_compare_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cbool:;
_Ncp1_Nexpr_i_Prd_bool_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cchar:;
_Ncp1_Nexpr_i_Prd_char_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cmath:;
_Ncp1_Nexpr_i_Prd_math_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cunary:;
_Ncp1_Nexpr_i_Prd_unary_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cref:;
_Ncp1_Nexpr_i_Prd_ref_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Ccast_fast:;
_Ncp1_Nexpr_i_Prd_cast_fast_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Clvar:;
_Ncp1_Nexpr_i_Prd_lvar_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cfvar:;
_Ncp1_Nexpr_i_Prd_fvar_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cgvar:;
_Ncp1_Nexpr_i_Prd_gvar_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Ccvar:;
_Ncp1_Nexpr_i_Prd_cvar_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cbools:;
_Ncp1_Nexpr_i_Prd_bools_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cmethod:;
_Ncp1_Nexpr_i_Prd_method_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cfunc:;
_Ncp1_Nexpr_i_Prd_func_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cstr:;
_Ncp1_Nexpr_i_Prd_str_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Ci32:;
_Ncp1_Nexpr_i_Prd_i32_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Csize_of_type:;
_Ncp1_Nexpr_i_Prd_size_of_type_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cnull:;
_Ncp1_Nexpr_i_Prd_null_2(_Le_idx_3, _Lr_1);
break;
case _Ncp1_Nexpr_type_Cindex:;
_Ncp1_Nexpr_i_Prd_index_2(_Le_idx_3, _Lr_1);
break;
default:;
fprintf(stdout, "rd() was not implemented in expression #%s\n", _Ncp1_Nexpr_type_Pcp1_name_1(_Ltype_2));
exit(_Nstdc_Nexit_Cfailure);
break;
}
}
...
inline void _Ncp1_Nenum_flags_Prd_2(_Ncp1_Nenum_flags* _Le_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Le_0) = (_Ncp1_Nenum_flags)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
}
inline void _Ncp1_Nstruct_flags_Prd_2(_Ncp1_Nstruct_flags* _Lf_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Lf_0) = (_Ncp1_Nstruct_flags)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
}
void _Ncp1_Nfarg_Prd_2(struct _Ncp1_Nfarg* _Lf_0, union _Ncp1_Nrdr* _Lr_1) {
_Ncp1_Ndecl_var_data_Prd_2(&(*_Lf_0)._Fdecl, _Lr_1);
}
inline void _Ncp1_Nfunc_flags_Prd_2(_Ncp1_Nfunc_flags* _Le_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Le_0) = (_Ncp1_Nfunc_flags)(Fgetnum(_Lr_1));
}
void* qalloc(int32_t _Lsize_0) {
if(sizeof(void*) == 8) {
_Lsize_0 = ((_Lsize_0 + 7) & (-1 ^ 7));
...
inline struct _Ncp1_Nfile_data* _Ncp1_Nfile_Pptr_1(_Ncp1_Nfile _Lf_0) {
return &_Gfile_v[_Lf_0];
}
_Ncp1_Nat _Ncp1_Pat_validate_5(_Ncp1_Nat _Lvd_type_0, _Ncp1_Nat _Lat_i_1, _Ncp1_Nfile _Lfile_2, uint32_t _Lrow_3, uint32_t _Lcol_4) {
struct _Ncp1_Nat_data* _Ltype_5;
struct _Ncp1_Nat_data* _Lparent_6;
_Ltype_5 = _Ncp1_Nat_Pptr_1(_Lvd_type_0);
_Lparent_6 = _Ncp1_Nat_Pptr_1((*_Ltype_5)._Fparent);
if((((*_Lparent_6)._Ftype == _Ncp1_Nname_type_Cbasic) && ((*_Lparent_6)._Fname._Fbasic == _Ncp1_Nbasic_type_id_Crelative))) {
union _Ncp1_Nat_name* _Lname_7;
...
i --;
if(((_Gat_v[_Li_8]._Fparent == _Lat_i_1) && (_Gat_v[_Li_8]._Ftype != _Ncp1_Nname_type_Cbasic))) {
...
_Ncp1_Ndecl_var_data_Prd_2(&(*_Ll_4)._Fdecl, _Lr_1);
_Ncp1_Nlvar_flags_Prd_2(&(*_Ll_4)._Fflags, _Lr_1);
if(((*_Ll_4)._Fflags & _Ncp1_Nlvar_flags_Cset_expr) != _Ncp1_Nlvar_flags_C0) {
_Ncp1_Nexpr_i_Prd_2(&(*_Ll_4)._Fset_expr, _Lr_1);
}
continue_0:;
_Li_3++;
}
...
break_0:;
while(1) {
_Ncp1_Nstmt_type _Ltype_5;
uint32_t _Lbegin_row_6;
uint32_t _Lbegin_col_7;
uint32_t _Lend_row_8;
uint32_t _Lend_col_9;
_Ncp1_Nstmt_type_Prd_2(&_Ltype_5, _Lr_1);
if(_Ltype_5 == _Ncp1_Nstmt_type_Cnil) {
goto break_1;
}
if(_Ncp1_Cdebug_rd_wr) {
if(_Ncp1_Nrdr_Pn1_1(_Lr_1) != 255) {
...
_Ncp1_Nstmt_space_Prd_expr_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cif:;
_Ncp1_Nstmt_space_Prd_if_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cif_elif:;
_Ncp1_Nstmt_space_Prd_if_elif_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cif_else:;
_Ncp1_Nstmt_space_Prd_if_else_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cif_end:;
_Ncp1_Nstmt_space_Prd_if_end_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cswitch:;
_Ncp1_Nstmt_space_Prd_switch_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Ccase:;
_Ncp1_Nstmt_space_Prd_case_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Ccase_end:;
_Ncp1_Nstmt_space_Prd_case_end_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cdefault:;
_Ncp1_Nstmt_space_Prd_default_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cdefault_end:;
_Ncp1_Nstmt_space_Prd_default_end_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cswitch_end:;
_Ncp1_Nstmt_space_Prd_switch_end_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cdo:;
_Ncp1_Nstmt_space_Prd_do_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cdo_end:;
_Ncp1_Nstmt_space_Prd_do_end_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cwhile:;
_Ncp1_Nstmt_space_Prd_while_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cwhile_end:;
_Ncp1_Nstmt_space_Prd_while_end_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Ccontinue:;
_Ncp1_Nstmt_space_Prd_continue_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cbreak:;
_Ncp1_Nstmt_space_Prd_break_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Creturn:;
_Ncp1_Nstmt_space_Prd_return_2(_Lspace_0, _Lr_1);
break;
case _Ncp1_Nstmt_type_Cspace:;
_Ncp1_Nstmt_space_Prd_space_2(_Lspace_0, _Lr_1);
break;
default:;
fprintf(stdout, "rd() not yet implemented in stmt #%s\n", _Ncp1_Nstmt_type_Pcp1_name_1(_Ltype_5));
exit(_Nstdc_Nexit_Cfailure);
break;
}
if(_Ncp1_Cdebug_rd_wr) {
...
break;
default:;
fprintf(stdout, "%s:%u:%u - %u:%u: process() is not implemented in statement #%s\n", _Ncp1_Nfile_Ppath_1((*_Gctx_func)._Ffile), (*_Ls_0)._Fbegin_row, (*_Ls_0)._Fbegin_col, (*_Ls_0)._Fend_row, (*_Ls_0)._Fend_col, _Ncp1_Nstmt_type_Pcp1_name_1((*_Ls_0)._Ftype));
break;
}
if(!(_Lok_1)) {
...
if(!(_Ncp1_Ndecl_var_data_Pprocess_5(&(*_Ls_4)._Ffvar_v[_Li_9]._Fdecl, _Ls_file_6, _Ls_row_7, _Ls_col_8, _Ls_at_5))) {
fprintf(stdout, "err\n");
exit(_Nstdc_Nexit_Cfailure);
return;
}
...
if(((*_Ls_4)._Fflags & _Ncp1_Nstruct_flags_Cno_decl) == _Ncp1_Nstruct_flags_C0) {
...
_Ln3_2 = (_Lnum_1 >> 3);
_Ln17_3 = (1 << (_Lnum_1 & 7));
if((_Gexpr_is_processed[_Ln3_2] & _Ln17_3) != _Ncp1_Nexpr_i_C0) {
return true;
}
_Gexpr_is_processed[_Ln3_2] |= _Ln17_3;
_Lexpr_4 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
_Lok_5 = false;
switch((*_Lexpr_4)._Ftype) {
case _Ncp1_Nexpr_type_Cassign:;
_Ncp1_Nexpr_i_Pprocess_assign_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Ccompare:;
_Ncp1_Nexpr_i_Pprocess_compare_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cbool:;
_Ncp1_Nexpr_i_Pprocess_bool_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cchar:;
_Ncp1_Nexpr_i_Pprocess_char_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cmath:;
_Ncp1_Nexpr_i_Pprocess_math_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cunary:;
_Ncp1_Nexpr_i_Pprocess_unary_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cref:;
_Ncp1_Nexpr_i_Pprocess_ref_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Ccast_fast:;
_Ncp1_Nexpr_i_Pprocess_cast_fast_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Clvar:;
_Ncp1_Nexpr_i_Pprocess_lvar_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cfvar:;
_Ncp1_Nexpr_i_Pprocess_fvar_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cgvar:;
_Ncp1_Nexpr_i_Pprocess_gvar_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Ccvar:;
_Ncp1_Nexpr_i_Pprocess_cvar_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cbools:;
_Ncp1_Nexpr_i_Pprocess_bools_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cmethod:;
_Ncp1_Nexpr_i_Pprocess_method_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cfunc:;
_Ncp1_Nexpr_i_Pprocess_func_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cstr:;
_Ncp1_Nexpr_i_Pprocess_str_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Ci32:;
_Ncp1_Nexpr_i_Pprocess_i32_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Csize_of_type:;
_Ncp1_Nexpr_i_Pprocess_size_of_type_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cnull:;
_Ncp1_Nexpr_i_Pprocess_null_2(_Lexpr_4, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cindex:;
_Ncp1_Nexpr_i_Pprocess_index_2(_Lexpr_4, &_Lok_5);
break;
default:;
fprintf(stdout, "%s:%u:%u - %u:%u: process() not implemented for expression #%s\n", _Ncp1_Nfile_Ppath_1((*_Gctx_func)._Ffile), _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nexpr_type_Pcp1_name_1((*_Lexpr_4)._Ftype));
return false;
break;
}
if(!(_Lok_5)) {
...
inline void _Ncp1_Nexpr_i_Pwrite_assign_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_assign* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fleft, &(*_Le_1)._Fleft_val);
switch((*_Le_1)._Ftype) {
...
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fright, &(*_Le_1)._Fright_val);
}
inline void _Ncp1_Nexpr_i_Pwrite_compare_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_compare* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fleft, &(*_Le_1)._Fleft_val);
switch((*_Le_1)._Ftype) {
...
inline void _Ncp1_Nexpr_i_Pwrite_bool_1(struct _Ncp1_Nexpr* _Lexpr_0) {
...
inline void _Ncp1_Nexpr_i_Pwrite_char_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_char* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Pwrite_char_1((*_Le_1)._Fvalue);
}
inline void _Ncp1_Nexpr_i_Pwrite_math_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_math* _Le_1;
_Le_1 = _Lexpr_0;
switch((*_Le_1)._Ftype) {
...
i --;
fprintf(_Gout, " + ");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fitem_v[_Li_2]._Fexpr, &(*_Le_1)._Fitem_v[_Li_2]._Fval);
continue_0:;
_Li_2++;
}
break_0:;
...
i --;
fprintf(_Gout, " - ");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fitem_v[_Li_3]._Fexpr, &(*_Le_1)._Fitem_v[_Li_3]._Fval);
continue_1:;
_Li_3++;
}
break_1:;
...
i --;
fprintf(_Gout, " * ");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fitem_v[_Li_4]._Fexpr, &(*_Le_1)._Fitem_v[_Li_4]._Fval);
continue_2:;
_Li_4++;
}
break_2:;
...
i --;
fprintf(_Gout, " / ");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fitem_v[_Li_5]._Fexpr, &(*_Le_1)._Fitem_v[_Li_5]._Fval);
continue_3:;
_Li_5++;
}
break_3:;
...
i --;
fprintf(_Gout, " & ");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fitem_v[_Li_6]._Fexpr, &(*_Le_1)._Fitem_v[_Li_6]._Fval);
continue_4:;
_Li_6++;
}
break_4:;
...
i --;
fprintf(_Gout, " | ");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fitem_v[_Li_7]._Fexpr, &(*_Le_1)._Fitem_v[_Li_7]._Fval);
continue_5:;
_Li_7++;
}
break_5:;
...
i --;
fprintf(_Gout, " ^ ");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fitem_v[_Li_8]._Fexpr, &(*_Le_1)._Fitem_v[_Li_8]._Fval);
continue_6:;
_Li_8++;
}
break_6:;
...
inline void _Ncp1_Nexpr_i_Pwrite_unary_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_unary* _Le_1;
_Le_1 = _Lexpr_0;
switch((*_Le_1)._Ftype) {
case _Ncp1_Nunary_Cneg:;
fprintf(_Gout, "-");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fexpr, &(*_Le_1)._Fval);
break;
...
inline void _Ncp1_Nexpr_i_Pwrite_ref_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_ref* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fexpr, &(*_Le_1)._Fval);
}
inline void _Ncp1_Nexpr_i_Pwrite_lvar_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_lvar* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Ndecl_var_data_Pwrite_lvar_2(&(*_Ncp1_Nlvar_Pptr_1((*_Le_1)._Flvar))._Fdecl, (*_Le_1)._Flvar);
}
inline void _Ncp1_Nexpr_i_Pwrite_fvar_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_fvar* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fexpr, &(*_Le_1)._Fval);
fprintf(_Gout, ".");
_Ncp1_Ndecl_var_data_Pwrite_2(&(*_Ncp1_Nstruct_Pptr_1((*_Ncp1_Nat_Pptr_1((*_Le_1)._Fval._Ftype))._Fdecl._Fstruct))._Ffvar_v[(*_Le_1)._Ffvar]._Fdecl, _Ncp1_Ndecl_var_type_Cfvar);
}
inline void _Ncp1_Nexpr_i_Pwrite_gvar_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_gvar* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Ngvar_Pwrite_1((*_Le_1)._Fgvar);
}
inline void _Ncp1_Nexpr_i_Pwrite_cvar_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_cvar* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Ncvar_Pwrite_1((*_Le_1)._Fcvar);
}
inline void _Ncp1_Nexpr_i_Pwrite_bools_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_bools* _Le_1;
_Le_1 = _Lexpr_0;
switch((*_Le_1)._Ftype) {
...
for(int i = (*_Le_1)._Fitem_c; i > 0; ) {
i --;
struct _Ncp1_Nexpr_bools_item* _Litem_3;
fprintf(_Gout, " && ");
_Litem_3 = (&(*_Le_1)._Fitem_v[_Li_2]);
_Ncp1_Nexpr_i_Pwrite_value_2((*_Litem_3)._Fexpr, &(*_Litem_3)._Fval);
continue_0:;
_Li_2++;
}
break_0:;
...
for(int i = (*_Le_1)._Fitem_c; i > 0; ) {
i --;
struct _Ncp1_Nexpr_bools_item* _Litem_5;
fprintf(_Gout, " || ");
_Litem_5 = (&(*_Le_1)._Fitem_v[_Li_4]);
_Ncp1_Nexpr_i_Pwrite_value_2((*_Litem_5)._Fexpr, &(*_Litem_5)._Fval);
continue_1:;
_Li_4++;
}
break_1:;
...
inline void _Ncp1_Nexpr_i_Pwrite_method_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_method* _Le_1;
struct _Ncp1_Ndecl_func* _Lf_2;
bool _Lfirst_3;
int32_t _Li_4;
_Le_1 = _Lexpr_0;
_Lf_2 = _Ncp1_Nfunc_Pptr_1((*_Le_1)._Ffunc_idx);
_Ncp1_Ndecl_func_Pwrite_1(_Lf_2);
fprintf(_Gout, "(");
_Lfirst_3 = true;
_Li_4 = 0;
...
_Ncp1_Nexpr_i_Pwrite_value_2((*_Lca_5)._Fexpr, &(*_Lca_5)._Fvalue);
continue_0:;
_Li_4++;
}
break_0:;
...
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fthis, &(*_Le_1)._Fthis_value);
for(int i = (*_Le_1)._Fcarg_c - (*_Lf_2)._Fthis_idx; i > 0; ) {
i --;
struct _Ncp1_Ncarg* _Lca_6;
fprintf(_Gout, ", ");
_Lca_6 = (&(*_Le_1)._Fcarg_v[_Li_4]);
_Ncp1_Nexpr_i_Pwrite_value_2((*_Lca_6)._Fexpr, &(*_Lca_6)._Fvalue);
continue_1:;
_Li_4++;
}
break_1:;
...
inline void _Ncp1_Nexpr_i_Pwrite_func_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_func* _Le_1;
struct _Ncp1_Ndecl_func* _Lf_2;
_Le_1 = _Lexpr_0;
_Lf_2 = _Ncp1_Nfunc_Pptr_1((*_Le_1)._Ffunc_idx);
_Ncp1_Ndecl_func_Pwrite_1(_Lf_2);
...
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fcarg_v[_Li_3]._Fexpr, &(*_Le_1)._Fcarg_v[_Li_3]._Fvalue);
continue_0:;
_Li_3++;
}
break_0:;
...
inline void _Ncp1_Nexpr_i_Pwrite_str_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_str* _Le_1;
...
inline void _Ncp1_Nexpr_i_Pwrite_i32_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_int_data* _Le_1;
_Le_1 = _Lexpr_0;
fprintf(_Gout, "%d", (*_Le_1)._Fvalue);
}
inline void _Ncp1_Nexpr_i_Pwrite_size_of_type_1(struct _Ncp1_Nexpr* _Lexpr_0) {
...
inline void _Ncp1_Nexpr_i_Pwrite_null_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_null* _Le_1;
_Le_1 = _Lexpr_0;
fprintf(_Gout, "NULL");
}
inline void _Ncp1_Nexpr_i_Pwrite_index_1(struct _Ncp1_Nexpr* _Lexpr_0) {
struct _Ncp1_Nexpr_index* _Le_1;
_Le_1 = _Lexpr_0;
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fleft, &(*_Le_1)._Fleft_val);
fprintf(_Gout, "[");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_1)._Fright, &(*_Le_1)._Fright_val);
...
switch(_Lvar_type_1) {
case _Ncp1_Ndecl_var_type_Cgvar:;
fprintf(_Gout, "_G%s", _Ncp1_Nid_Pc_name_1((*_Lvd_0)._Fname));
break;
case _Ncp1_Ndecl_var_type_Cfvar:;
...
int8_t _Lref_3;
_Lexpr_2 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
_Lref_3 = (*_Lv_1)._Fref;
if((*_Lv_1)._Fparen) {
if(_Lref_3 <= 0) {
...
if((*_Lexpr_2)._Ftype == _Ncp1_Nexpr_type_Ccast_fast) {
struct _Ncp1_Nexpr_cast_fast* _Le_4;
_Le_4 = _Lexpr_2;
_Ncp1_Nexpr_cast_fast_Pwrite_value_2(_Le_4, _Lv_1);
} else {
_Ncp1_Nexpr_i_Pwrite_1(_Le_0);
}
if((*_Lv_1)._Fparen) {
_Nstdc_Nfile_Pwrite_3(_Gout, ")", 1);
}
...
break;
default:;
fprintf(stdout, "write() not yet implemented in stmt #%s\n", _Ncp1_Nstmt_type_Pcp1_name_1((*_Ls_0)._Ftype));
exit(_Nstdc_Nexit_Cfailure);
break;
}
}
inline void _Ncp1_Nvar_flags_Prd_2(_Ncp1_Nvar_flags* _Lf_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Lf_0) = (_Ncp1_Nvar_flags)(Fgetnum(_Lr_1));
}
void _Ncp1_Ntype_info_Prd_2(struct _Ncp1_Ntype_info* _Lti_0, union _Ncp1_Nrdr* _Lr_1) {
uint8_t _Lc_2;
...
inline void _Ncp1_Nexpr_type_Prd_2(_Ncp1_Nexpr_type* _Le_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Le_0) = (_Ncp1_Nexpr_type)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
}
inline void _Ncp1_Nexpr_i_Prd_assign_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_assign* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cassign);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fleft, _Lr_1);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fright, _Lr_1);
_Ncp1_Nassign_Prd_2(&(*_Le_2)._Ftype, _Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_compare_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_compare* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Ccompare);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fleft, _Lr_1);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fright, _Lr_1);
_Ncp1_Ncompare_Prd_2(&(*_Le_2)._Ftype, _Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_bool_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_bool* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cbool);
(*_Le_2)._Fvalue = _Ncp1_Nrdr_Pb_1(_Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_char_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_char* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cchar);
(*_Le_2)._Fvalue = Fgetnum(_Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_math_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_math* _Le_2;
uint8_t _Litem_c_3;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cmath);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fleft, _Lr_1);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fright, _Lr_1);
...
i --;
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fitem_v[_Li_4]._Fexpr, _Lr_1);
continue_0:;
_Li_4++;
}
break_0:;
...
inline void _Ncp1_Nexpr_i_Prd_unary_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_unary* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cunary);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fexpr, _Lr_1);
_Ncp1_Nunary_Prd_2(&(*_Le_2)._Ftype, _Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_ref_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_ref* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cref);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fexpr, _Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_cast_fast_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_cast_fast* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Ccast_fast);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fexpr, _Lr_1);
_Ncp1_Nat_Prd_2(&(*_Le_2)._Ftype, _Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_lvar_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_lvar* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Clvar);
_Ncp1_Nlvar_Prd_2(&(*_Le_2)._Flvar, _Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_fvar_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_fvar* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cfvar);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fexpr, _Lr_1);
_Ncp1_Nid_Prd_2(&(*_Le_2)._Fmember, _Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_gvar_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_gvar* _Le_2;
_Ncp1_Nat _Lat_idx_3;
_Ncp1_Nid _Lname_4;
bool _Ltry_parent_5;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cgvar);
...
inline void _Ncp1_Nexpr_i_Prd_cvar_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_cvar* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Ccvar);
_Ncp1_Nat_Prd_2(&(*_Le_2)._Fat, _Lr_1);
_Ncp1_Nid_Prd_2(&(*_Le_2)._Fname, _Lr_1);
(*_Le_2)._Ftry = _Ncp1_Nat_Cnil;
}
inline void _Ncp1_Nexpr_i_Prd_bools_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_bools* _Le_2;
uint8_t _Litem_c_3;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cbools);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fleft, _Lr_1);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fright, _Lr_1);
_Litem_c_3 = _Ncp1_Nrdr_Pn1_1(_Lr_1);
if(_Litem_c_3 > 0) {
...
inline void _Ncp1_Nexpr_i_Prd_method_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
_Ncp1_Nexpr_i _Lthis_expr_2;
_Ncp1_Nid _Lfunc_name_3;
uint8_t _Lgroup_c_4;
int8_t _Lgroup_v_5[_Ncp1_Cexpr_carg_group_limit];
uint8_t _Lcarg_c_7;
struct _Ncp1_Nexpr_method* _Le_8;
_Ncp1_Nexpr_i_Prd_2(&_Lthis_expr_2, _Lr_1);
...
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_8)._Fbase, _Ncp1_Nexpr_type_Cmethod);
...
i --;
_Ncp1_Nexpr_i_Prd_2(&(*_Le_8)._Fcarg_v[_Li_10]._Fexpr, _Lr_1);
continue_2:;
_Li_10++;
}
break_2:;
}
inline void _Ncp1_Nexpr_i_Prd_func_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
_Ncp1_Nat _Lat_idx_2;
_Ncp1_Nid _Lfunc_name_3;
uint8_t _Lgroup_c_4;
int8_t _Lgroup_v_5[_Ncp1_Cexpr_carg_group_limit];
uint8_t _Lcarg_c_7;
struct _Ncp1_Nexpr_func* _Le_8;
...
_Lcarg_c_7 = _Ncp1_Nrdr_Pn1_1(_Lr_1);
_Ncp1_Pquick_alloc_plus_2(_Le_8, sizeof(struct _Ncp1_Ncarg) * _Lcarg_c_7);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_8)._Fbase, _Ncp1_Nexpr_type_Cfunc);
...
inline void _Ncp1_Nexpr_i_Prd_str_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
uint32_t _Lnode_c_2;
struct _Ncp1_Nexpr_str* _Le_3;
bool _Lfirst_4;
_Lnode_c_2 = Fgetnum(_Lr_1);
_Ncp1_Pquick_alloc_one_1(_Le_3);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_3)._Fbase, _Ncp1_Nexpr_type_Cstr);
_Lfirst_4 = true;
for(int i = _Lnode_c_2; i > 0; ) {
i --;
uint32_t _Llen_5;
struct _Ncp1_Nexpr_str_node* _Ln_6;
...
inline void _Ncp1_Nexpr_i_Prd_i32_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_int_data* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Ci32);
(*_Le_2)._Ftype = (_Ncp1_Nexpr_int)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
(*_Le_2)._Fvalue = Fgetnum(_Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_size_of_type_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_size_of_type* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Csize_of_type);
_Ncp1_Nat_Prd_2(&(*_Le_2)._Ftype, _Lr_1);
}
inline void _Ncp1_Nexpr_i_Prd_null_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_null* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cnull);
}
inline void _Ncp1_Nexpr_i_Prd_index_2(_Ncp1_Nexpr_i _Le_idx_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nexpr_index* _Le_2;
_Ncp1_Pquick_alloc_one_1(_Le_2);
_Ncp1_Nexpr_i_Pset_3(_Le_idx_0, &(*_Le_2)._Fbase, _Ncp1_Nexpr_type_Cindex);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fleft, _Lr_1);
_Ncp1_Nexpr_i_Prd_2(&(*_Le_2)._Fright, _Lr_1);
}
inline void _Ncp1_Nlvar_flags_Prd_2(_Ncp1_Nlvar_flags* _Lf_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Lf_0) = (_Ncp1_Nlvar_flags)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
}
inline void _Ncp1_Nlvar_Prd_2(_Ncp1_Nlvar* _Ll_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Ll_0) = ((_Ncp1_Nlvar)(Fgetnum(_Lr_1) - 1));
}
inline void _Ncp1_Nstmt_type_Prd_2(_Ncp1_Nstmt_type* _Ls_0, union _Ncp1_Nrdr* _Lr_1) {
(*_Ls_0) = (_Ncp1_Nstmt_type)(_Ncp1_Nrdr_Pn1_1(_Lr_1));
}
inline void _Ncp1_Nstmt_space_Prd_expr_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_expr* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_2)._Fexpr, _Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cexpr);
}
inline void _Ncp1_Nstmt_space_Prd_if_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_if* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
(*_Ls_2)._Fnot = _Ncp1_Nrdr_Pb_1(_Lr_1);
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_2)._Fexpr, _Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cif);
}
inline void _Ncp1_Nstmt_space_Prd_if_elif_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_if_elif* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
(*_Ls_2)._Fnot = _Ncp1_Nrdr_Pb_1(_Lr_1);
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_2)._Fexpr, _Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cif_elif);
}
inline void _Ncp1_Nstmt_space_Prd_if_else_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_if_else* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, 0, 0, 0, 0, _Ncp1_Nstmt_type_Cif_else);
}
inline void _Ncp1_Nstmt_space_Prd_if_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_if_end* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, 0, 0, 0, 0, _Ncp1_Nstmt_type_Cif_end);
}
inline void _Ncp1_Nstmt_space_Prd_switch_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_switch* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_2)._Fexpr, _Lr_1);
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_2)._Fcases, _Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cswitch);
}
inline void _Ncp1_Nstmt_space_Prd_case_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
uint32_t _Lexpr_c_2;
struct _Ncp1_Nstmt_case* _Ls_3;
_Lexpr_c_2 = Fgetnum(_Lr_1);
_Ncp1_Pquick_alloc_plus_2(_Ls_3, sizeof(struct _Ncp1_Nstmt_case_item) * _Lexpr_c_2);
(*_Ls_3)._Fexpr_c = _Lexpr_c_2;
int32_t _Li_4;
_Li_4 = 0;
for(int i = _Lexpr_c_2; i > 0; ) {
i --;
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_3)._Fexpr_v[_Li_4]._Fexpr, _Lr_1);
continue_0:;
_Li_4++;
}
break_0:;
(*_Ls_3)._Ffall_through = _Ncp1_Nrdr_Pb_1(_Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_3)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Ccase);
}
inline void _Ncp1_Nstmt_space_Prd_case_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_case_end* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Ccase_end);
}
inline void _Ncp1_Nstmt_space_Prd_default_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_default* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
(*_Ls_2)._Ffall_through = _Ncp1_Nrdr_Pb_1(_Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cdefault);
}
inline void _Ncp1_Nstmt_space_Prd_default_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_default_end* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cdefault_end);
}
inline void _Ncp1_Nstmt_space_Prd_switch_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_switch_end* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, 0, 0, 0, 0, _Ncp1_Nstmt_type_Cswitch_end);
}
inline void _Ncp1_Nstmt_space_Prd_do_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_do* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_2)._Fexpr, _Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cdo);
if(_Ncp1_Nrdr_Pb_1(_Lr_1)) {
struct _Ncp1_Nstmt_space* _Lspace2_3;
...
inline void _Ncp1_Nstmt_space_Prd_do_end_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_do* _Ldo_2;
struct _Ncp1_Nstmt_do_end* _Ls_3;
_Ldo_2 = _Gnest_stack_ptr_v[(_Gnest_stack_c -= 1)]._Fdo;
_Ncp1_Pquick_alloc_one_1(_Ls_3);
(*_Ls_3)._Fdo = _Ldo_2;
(*_Ldo_2)._Fend = _Ls_3;
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_3)._Fbase, 0, 0, 0, 0, _Ncp1_Nstmt_type_Cdo_end);
}
inline void _Ncp1_Nstmt_space_Prd_while_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_while* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_2)._Fexpr, _Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cwhile);
if(_Ncp1_Nrdr_Pb_1(_Lr_1)) {
struct _Ncp1_Nstmt_space* _Lspace2_3;
_Ncp1_Pquick_alloc_one_1(_Lspace2_3);
(*_Ls_2)._Fcontinu = _Lspace2_3;
...
struct _Ncp1_Nstmt_continue* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
(*_Ls_2)._Fnest = _Ncp1_Nrdr_Pn1_1(_Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Ccontinue);
}
inline void _Ncp1_Nstmt_space_Prd_break_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_break* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
(*_Ls_2)._Fnest = _Ncp1_Nrdr_Pn1_1(_Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cbreak);
}
inline void _Ncp1_Nstmt_space_Prd_return_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_return* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nexpr_i_Prd_2(&(*_Ls_2)._Fexpr, _Lr_1);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Creturn);
}
inline void _Ncp1_Nstmt_space_Prd_space_2(struct _Ncp1_Nstmt_space* _Lspace_0, union _Ncp1_Nrdr* _Lr_1) {
struct _Ncp1_Nstmt_space* _Ls_2;
_Ncp1_Pquick_alloc_one_1(_Ls_2);
_Ncp1_Nstmt_space_Prd_3(_Ls_2, _Lr_1, _Lspace_0);
_Ncp1_Nstmt_space_Pstmt_push_7(_Lspace_0, &(*_Ls_2)._Fbase, _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nstmt_type_Cspace);
}
inline void _Ncp1_Nstmt_Pprocess_expr_2(struct _Ncp1_Nstmt* _Lstmt_0, bool* _Lok_1) {
struct _Ncp1_Nstmt_expr* _Ls_2;
_Ls_2 = _Lstmt_0;
if(!(_Ncp1_Nexpr_i_Pprocess_1((*_Ls_2)._Fexpr))) {
return;
}
(*_Lok_1) = true;
}
...
struct _Ncp1_Nstmt_if* _Ls_2;
_Ls_2 = _Lstmt_0;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Ls_2)._Fexpr, 1, false, &(*_Ls_2)._Fval))) {
return;
}
(*_Lok_1) = true;
}
...
struct _Ncp1_Ndecl_func* _Lfunc_12;
...
struct _Ncp1_Nstmt_switch_case_func* _Lfunc_v_17;
if(!(_Ncp1_Nexpr_i_Pprocess_case_func_2(_Ncp1_Nexpr_i_Pptr_1((*_Ls_2)._Fcases), _Lcase_v_9[0]))) {
return;
}
...
struct _Ncp1_Ndecl_func* _Lfunc_20;
...
struct _Ncp1_Ncvar_data* _Lcvar_29;
...
i --;
_Ncp1_Nexpr_i _Le_i_7;
struct _Ncp1_Nexpr* _Le_8;
_Le_i_7 = (*_Ls_2)._Fexpr_v[_Li_6]._Fexpr;
_Le_8 = _Ncp1_Nexpr_i_Pptr_1(_Le_i_7);
if((*_Le_8)._Ftype == _Ncp1_Nexpr_type_Ccvar) {
struct _Ncp1_Nexpr_cvar* _Le2_9;
_Le2_9 = _Le_8;
...
for(int i = (*_Ls_2)._Fexpr_c; i > 0; ) {
i --;
_Ncp1_Nexpr_i _Le_i_11;
_Le_i_11 = (*_Ls_2)._Fexpr_v[_Li_10]._Fexpr;
if(!(_Ncp1_Nexpr_i_Pvalue_4(_Le_i_11, 1, true, &(*_Ls_2)._Fexpr_v[_Li_10]._Fval))) {
return;
}
continue_1:;
_Li_10++;
...
struct _Ncp1_Nstmt_do* _Ls_2;
_Ls_2 = _Lstmt_0;
if((*_Ls_2)._Fexpr != _Ncp1_Nexpr_i_Cnil) {
if(!(_Ncp1_Nexpr_i_Pprocess_1((*_Ls_2)._Fexpr))) {
return;
}
}
...
struct _Ncp1_Nstmt_do_end* _Ls_2;
...
_Ls_2 = _Lstmt_0;
if((*_Ls_2)._Fexpr != _Ncp1_Nexpr_i_Cnil) {
_Ncp1_Nexpr_i_Ptry_deduce_2((*_Ls_2)._Fexpr, (*_Gctx_func)._Fdecl._Ftype);
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Ls_2)._Fexpr, 1 + (*_Gctx_func)._Fdecl._Ftype_info._Fref_v[(*_Gctx_func)._Fdecl._Ftype_info._Farray_c], false, &(*_Ls_2)._Fval))) {
return;
}
}
(*_Lok_1) = true;
...
_Lspace_2 = _Lstmt_0;
if(!(_Ncp1_Nstmt_space_Pprocess_1(_Lspace_2))) {
return;
}
(*_Lok_1) = true;
}
...
for(int i = (*_Lvd_0)._Fsize_c; i > 0; ) {
i --;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Lvd_0)._Fsize_expr_v[_Li_7], 1, false, &(*_Lvd_0)._Fsize_value_v[_Li_7]))) {
return false;
}
continue_0:;
_Li_7++;
...
inline void _Ncp1_Nexpr_i_Pprocess_assign_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_assign* _Le_2;
struct _Ncp1_Nexpr* _Lleft_e_3;
_Le_2 = _Lexpr_0;
_Lleft_e_3 = _Ncp1_Nexpr_i_Pptr_1((*_Le_2)._Fleft);
if((*_Lleft_e_3)._Ftype == _Ncp1_Nexpr_type_Clvar) {
struct _Ncp1_Nexpr_lvar* _Lleft_4;
struct _Ncp1_Nlvar_data* _Llvar_5;
_Lleft_4 = _Lleft_e_3;
_Llvar_5 = _Ncp1_Nlvar_Pptr_1((*_Lleft_4)._Flvar);
if((*_Llvar_5)._Fdecl._Ftype == _Ncp1_Nat_Cnil) {
struct _Ncp1_Nat_data* _Lat_6;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fright, 1, true, &(*_Le_2)._Fright_val))) {
return;
}
(*_Llvar_5)._Fdecl._Ftype = (*_Le_2)._Fright_val._Ftype;
_Lat_6 = _Ncp1_Nat_Pptr_1((*_Llvar_5)._Fdecl._Ftype);
_Ncp1_Ntype_info_Pinit_1(&(*_Llvar_5)._Fdecl._Ftype_info);
_Ncp1_Ntype_info_Pcopy_from_2(&(*_Llvar_5)._Fdecl._Ftype_info, &(*_Le_2)._Fright_val._Finfo);
_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fleft, 1, true, &(*_Le_2)._Fleft_val);
(*_Lok_1) = true;
return;
}
}
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fleft, 1, true, &(*_Le_2)._Fleft_val))) {
return;
}
_Ncp1_Nexpr_i_Ptry_deduce_2((*_Le_2)._Fright, _Ncp1_Nexpr_i_Ptype_1((*_Le_2)._Fleft));
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fright, 1, true, &(*_Le_2)._Fright_val))) {
return;
}
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_compare_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_compare* _Le_2;
_Le_2 = _Lexpr_0;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fleft, 1, true, &(*_Le_2)._Fleft_val))) {
return;
}
_Ncp1_Nexpr_i_Ptry_deduce_2((*_Le_2)._Fright, (*_Le_2)._Fleft_val._Ftype);
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fright, 1, true, &(*_Le_2)._Fright_val))) {
return;
}
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_bool_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
_Ginclude_stdbool = true;
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_char_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_math_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_math* _Le_2;
_Le_2 = _Lexpr_0;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fleft, 1, true, &(*_Le_2)._Fleft_val))) {
return;
...
for(int i = (*_Le_2)._Fitem_c; i > 0; ) {
i --;
struct _Ncp1_Nexpr_math_item* _Litem_4;
_Litem_4 = (&(*_Le_2)._Fitem_v[_Li_3]);
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Litem_4)._Fexpr, 1, true, &(*_Litem_4)._Fval))) {
return;
}
continue_0:;
_Li_3++;
...
inline void _Ncp1_Nexpr_i_Pprocess_unary_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_unary* _Le_2;
_Le_2 = _Lexpr_0;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fexpr, 1, true, &(*_Le_2)._Fval))) {
return;
}
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_ref_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_ref* _Le_2;
_Le_2 = _Lexpr_0;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fexpr, 2, false, &(*_Le_2)._Fval))) {
return;
}
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_cast_fast_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_cast_fast* _Le_2;
_Le_2 = _Lexpr_0;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fexpr, 1, false, &(*_Le_2)._Fval))) {
return;
}
...
inline void _Ncp1_Nexpr_i_Pprocess_lvar_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_lvar* _Le_2;
_Le_2 = _Lexpr_0;
...
inline void _Ncp1_Nexpr_i_Pprocess_fvar_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_fvar* _Le_2;
_Ncp1_Nat _Ltype_i_3;
struct _Ncp1_Nat_data* _Ltype_4;
_Ncp1_Nstruct _Lstruct_i_5;
struct _Ncp1_Nstruct_data* _Lstruct_6;
_Ncp1_Nid _Lmember_7;
_Le_2 = _Lexpr_0;
_Ltype_i_3 = _Ncp1_Nexpr_i_Ptype_1((*_Le_2)._Fexpr);
...
if((*_Ltype_4)._Fdef != _Ncp1_Nat_def_Cstruct) {
fprintf(stdout, "%s:%u:%u - %u:%u Cannot get member '.%s' because the type is not a struct or union\n", _Ncp1_Nfile_Ppath_1((*_Gctx_func)._Ffile), _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nid_Pstr_1((*_Le_2)._Fmember));
return;
}
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fexpr, 1 - _Ncp1_Nat_Ppointer_1(_Ltype_i_3), true, &(*_Le_2)._Fval))) {
return;
}
...
inline void _Ncp1_Nexpr_i_Pprocess_gvar_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_gvar* _Le_2;
_Le_2 = _Lexpr_0;
...
inline void _Ncp1_Nexpr_i_Pprocess_cvar_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_cvar* _Le_2;
_Ncp1_Nid _Lname_3;
int32_t _Lcvar_c_4;
...
inline void _Ncp1_Nexpr_i_Pprocess_bools_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_bools* _Le_2;
_Le_2 = _Lexpr_0;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fleft, 1, true, &(*_Le_2)._Fleft_val))) {
return;
...
for(int i = (*_Le_2)._Fitem_c; i > 0; ) {
i --;
struct _Ncp1_Nexpr_bools_item* _Litem_4;
_Litem_4 = (&(*_Le_2)._Fitem_v[_Li_3]);
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Litem_4)._Fexpr, 1, true, &(*_Litem_4)._Fval))) {
return;
}
...
inline void _Ncp1_Nexpr_i_Pprocess_method_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_method* _Le_2;
_Ncp1_Nid _Lfunc_name_3;
uint8_t _Lgroup_c_4;
uint8_t* _Lgroup_v_5;
uint8_t _Lcarg_c_6;
...
_Lat_idx_8 = _Ncp1_Nexpr_i_Ptype_1((*_Le_2)._Fthis);
...
if((*_Lat_9)._Ftype == _Ncp1_Nname_type_Cbasic) {
struct _Ncp1_Nbasic_type* _Lt_12;
_Lt_12 = (&_Gbasic_type[(*_Lat_9)._Fname._Fbasic]);
_Lmethod_c_10 = (*_Lt_12)._Fmethod_c;
_Lmethod_v_11 = (*_Lt_12)._Fmethod_v;
} else {
if((((*_Lat_9)._Fdecl._Fstruct == _Ncp1_Nstruct_Cnil) && ((*_Lat_9)._Ftype != _Ncp1_Nname_type_Cbasic) && ((*_Lat_9)._Ftype != _Ncp1_Nname_type_Cmodule))) {
...
struct _Ncp1_Ndecl_func* _Lf_19;
bool _Lmatch_20;
_Ncp1_Nat _Lf_at_24;
int32_t _Lj_25;
int32_t _Lk_26;
...
_Lmatch_20 = true;
if(((*_Lf_19)._Fflags & _Ncp1_Nfunc_flags_Cvar_args) != _Ncp1_Nfunc_flags_C0) {
...
if(!(_Ncp1_Pfarg_process_5((*_Lca_27)._Fexpr, (*_Lca_27)._Fref, &(*_Lca_27)._Fvalue, &(*_Lf_19)._Ffarg_v[_Lj_25]._Fdecl, _Lf_at_24))) {
return;
}
continue_3:;
_Lj_25++;
...
break_3:;
if(!(_Ncp1_Pfarg_process_5((*_Le_2)._Fthis, 0, &(*_Le_2)._Fthis_value, &(*_Lf_19)._Ffarg_v[_Lj_25++]._Fdecl, _Lf_at_24))) {
return;
}
...
if(!(_Ncp1_Pfarg_process_5((*_Lca_28)._Fexpr, (*_Lca_28)._Fref, &(*_Lca_28)._Fvalue, &(*_Lf_19)._Ffarg_v[_Lj_25]._Fdecl, _Lf_at_24))) {
return;
}
continue_4:;
_Lj_25++;
...
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Lca_29)._Fexpr, _Lr_30, false, &(*_Lca_29)._Fvalue))) {
return;
}
continue_5:;
_Lk_26++;
...
struct _Ncp1_Ndecl_func* _Lf_33;
...
inline void _Ncp1_Nexpr_i_Pprocess_func_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_func* _Le_2;
_Ncp1_Nid _Lfunc_name_3;
uint8_t _Lcarg_c_4;
uint8_t _Lgroup_c_5;
uint8_t* _Lgroup_v_6;
...
struct _Ncp1_Ndecl_func* _Lf_12;
bool _Lmatch_13;
_Ncp1_Nat _Lf_at_17;
int32_t _Lj_18;
...
_Lmatch_13 = true;
if(((*_Lf_12)._Fflags & _Ncp1_Nfunc_flags_Cvar_args) != _Ncp1_Nfunc_flags_C0) {
...
if(!(_Ncp1_Pfarg_process_5((*_Lca_19)._Fexpr, (*_Lca_19)._Fref, &(*_Lca_19)._Fvalue, &(*_Lf_12)._Ffarg_v[_Lj_18]._Fdecl, _Lf_at_17))) {
return;
}
continue_4:;
_Lj_18++;
...
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Lca_20)._Fexpr, _Lr_21, false, &(*_Lca_20)._Fvalue))) {
return;
}
continue_5:;
_Lj_18++;
...
inline void _Ncp1_Nexpr_i_Pprocess_str_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_i32_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_size_of_type_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_size_of_type* _Le_2;
_Le_2 = _Lexpr_0;
(*_Le_2)._Ftype = _Ncp1_Pat_validate_5((*_Le_2)._Ftype, (*_Gctx_func)._Fat, (*_Gctx_func)._Ffile, _Gctx_begin_row, _Gctx_begin_col);
_Ncp1_Nat_Poutput_4((*_Le_2)._Ftype, (*_Gctx_func)._Ffile, _Gctx_begin_row, _Gctx_begin_col);
...
inline void _Ncp1_Nexpr_i_Pprocess_null_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
_Ginclude_stddef = true;
(*_Lok_1) = true;
}
inline void _Ncp1_Nexpr_i_Pprocess_index_2(struct _Ncp1_Nexpr* _Lexpr_0, bool* _Lok_1) {
struct _Ncp1_Nexpr_index* _Le_2;
_Le_2 = _Lexpr_0;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Le_2)._Fleft, 1, true, &(*_Le_2)._Fleft_val))) {
return;
...
void _Ncp1_Ngvar_Pwrite_1(_Ncp1_Ngvar _Lg_0) {
struct _Ncp1_Ndecl_gvar* _Lgvar_1;
_Lgvar_1 = _Ncp1_Ngvar_Pptr_1(_Lg_0);
_Ncp1_Ndecl_var_data_Pwrite_2(&(*_Lgvar_1)._Fdecl, _Ncp1_Ndecl_var_type_Cgvar);
}
inline void _Ncp1_Nexpr_cast_fast_Pwrite_value_2(struct _Ncp1_Nexpr_cast_fast* _Le_0, struct _Ncp1_Nvalue* _Lv_1) {
fprintf(_Gout, "(");
_Ncp1_Nat_Pwrite_type_info_3((*_Le_0)._Ftype, &(*_Lv_1)._Finfo, 0);
fprintf(_Gout, ")(");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Le_0)._Fexpr, &(*_Le_0)._Fval);
fprintf(_Gout, ")");
}
inline int32_t _Ncp1_Nat_Ppointer_1(_Ncp1_Nat _Ltd_0) {
if((*_Ncp1_Nat_Pptr_1(_Ltd_0))._Fdef == _Ncp1_Nat_def_Cstruct) {
return 1;
} else {
return 0;
}
...
struct _Ncp1_Nstmt_expr* _Ls_1;
struct _Ncp1_Nexpr* _Lexpr_2;
_Ls_1 = _Lstmt_0;
_Lexpr_2 = _Ncp1_Nexpr_i_Pptr_1((*_Ls_1)._Fexpr);
if((*_Lexpr_2)._Ftype == _Ncp1_Nexpr_type_Cstr) {
struct _Ncp1_Nexpr_str* _Le_3;
...
struct _Ncp1_Nstmt_if* _Ls_1;
struct _Ncp1_Nexpr* _Le_2;
_Ls_1 = _Lstmt_0;
_Le_2 = _Ncp1_Nexpr_i_Pptr_1((*_Ls_1)._Fexpr);
if((*_Ls_1)._Fnot) {
fprintf(_Gout, "if(!(");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Ls_1)._Fexpr, &(*_Ls_1)._Fval);
fprintf(_Gout, ")) {\n");
} else {
fprintf(_Gout, "if(");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Ls_1)._Fexpr, &(*_Ls_1)._Fval);
...
struct _Ncp1_Nstmt_if_elif* _Ls_1;
_Ls_1 = _Lstmt_0;
if((*_Ls_1)._Fnot) {
...
struct _Ncp1_Nexpr* _Le_2;
struct _Ncp1_Nexpr_func* _Lfunc_3;
struct _Ncp1_Nstmt_switch_case_func* _Lv_4;
_Le_2 = _Ncp1_Nexpr_i_Pptr_1((*_Ls_1)._Fcases);
_Lfunc_3 = _Le_2;
...
_Ncp1_Nexpr_i_Pwrite_func_1(_Le_2);
fprintf(_Gout, ";\nbreak;\n");
continue_0:;
_Li_5++;
}
...
i --;
fprintf(_Gout, "case ");
_Ncp1_Nexpr_i_Pwrite_value_2((*_Ls_1)._Fexpr_v[_Li_2]._Fexpr, &(*_Ls_1)._Fexpr_v[_Li_2]._Fval);
fprintf(_Gout, ":;\n");
continue_0:;
_Li_2++;
}
...
struct _Ncp1_Nstmt_continue* _Ls_1;
_Ls_1 = _Lstmt_0;
...
struct _Ncp1_Nstmt_space* _Lspace_1;
_Lspace_1 = _Lstmt_0;
_Ncp1_Nstmt_space_Pwrite_1(_Lspace_1);
}
inline void _Ncp1_Nexpr_i_Pset_3(_Ncp1_Nexpr_i _Le_0, struct _Ncp1_Nexpr* _Lexpr_1, _Ncp1_Nexpr_type _Ltype_2) {
...
inline void _Ncp1_Nstmt_space_Pstmt_push_7(struct _Ncp1_Nstmt_space* _Ls_0, struct _Ncp1_Nstmt* _Ls2_1, int32_t _Lbegin_row_2, int32_t _Lbegin_col_3, int32_t _Lend_row_4, int32_t _Lend_col_5, _Ncp1_Nstmt_type _Ltype_6) {
...
struct _Ncp1_Nexpr* _Lexpr_4;
bool _Lok_5;
if(!(_Ncp1_Nexpr_i_Pprocess_1(_Le_0))) {
return false;
}
_Lexpr_4 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
_Lok_5 = false;
switch((*_Lexpr_4)._Ftype) {
case _Ncp1_Nexpr_type_Cassign:;
_Ncp1_Nexpr_i_Pvalue_assign_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Ccompare:;
_Ncp1_Nexpr_i_Pvalue_compare_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cbool:;
_Ncp1_Nexpr_i_Pvalue_bool_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cchar:;
_Ncp1_Nexpr_i_Pvalue_char_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cmath:;
_Ncp1_Nexpr_i_Pvalue_math_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cunary:;
_Ncp1_Nexpr_i_Pvalue_unary_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cref:;
_Ncp1_Nexpr_i_Pvalue_ref_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Ccast_fast:;
_Ncp1_Nexpr_i_Pvalue_cast_fast_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Clvar:;
_Ncp1_Nexpr_i_Pvalue_lvar_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cfvar:;
_Ncp1_Nexpr_i_Pvalue_fvar_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cgvar:;
_Ncp1_Nexpr_i_Pvalue_gvar_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Ccvar:;
_Ncp1_Nexpr_i_Pvalue_cvar_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cbools:;
_Ncp1_Nexpr_i_Pvalue_bools_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cfunc:;
_Ncp1_Nexpr_i_Pvalue_func_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cmethod:;
_Ncp1_Nexpr_i_Pvalue_method_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cstr:;
_Ncp1_Nexpr_i_Pvalue_str_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Ci32:;
_Ncp1_Nexpr_i_Pvalue_i32_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Csize_of_type:;
_Ncp1_Nexpr_i_Pvalue_size_of_type_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cnull:;
_Ncp1_Nexpr_i_Pvalue_null_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
case _Ncp1_Nexpr_type_Cindex:;
_Ncp1_Nexpr_i_Pvalue_index_5(_Le_0, _Lref_1, _Lparen_2, _Lv_3, &_Lok_5);
break;
default:;
fprintf(stdout, "%u:%u - %u:%u: value() not implemented for #%s\n", _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nexpr_type_Pcp1_name_1((*_Lexpr_4)._Ftype));
break;
}
return _Lok_5;
}
inline bool _Ncp1_Nexpr_i_Pprocess_case_func_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nfunc _Lf_idx_1) {
struct _Ncp1_Nexpr_func* _Le_2;
_Ncp1_Nid _Lfunc_name_3;
uint8_t _Lcarg_c_4;
uint8_t _Lgroup_c_5;
uint8_t* _Lgroup_v_6;
struct _Ncp1_Nat_data* _Lat_7;
struct _Ncp1_Ndecl_func* _Lf_8;
_Ncp1_Nat _Lf_at_9;
int32_t _Lj_10;
_Le_2 = _Lexpr_0;
_Lfunc_name_3 = (*_Le_2)._Ffunc_name;
...
if(!(_Ncp1_Pfarg_process_5((*_Lca_11)._Fexpr, (*_Lca_11)._Fref, &(*_Lca_11)._Fvalue, &(*_Lf_8)._Ffarg_v[_Lj_10]._Fdecl, _Lf_at_9))) {
return false;
}
continue_0:;
_Lj_10++;
...
if(((*_Lf_8)._Fflags & _Ncp1_Nfunc_flags_Cvar_args) != _Ncp1_Nfunc_flags_C0) {
...
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Lca_12)._Fexpr, _Lr_13, false, &(*_Lca_12)._Fvalue))) {
return false;
}
continue_1:;
_Lj_10++;
...
void _Ncp1_Nexpr_i_Ptry_deduce_2(_Ncp1_Nexpr_i _Le_idx_0, _Ncp1_Nat _Lat_1) {
struct _Ncp1_Nexpr* _Lexpr_2;
_Lexpr_2 = _Ncp1_Nexpr_i_Pptr_1(_Le_idx_0);
switch((*_Lexpr_2)._Ftype) {
case _Ncp1_Nexpr_type_Cmath:;
_Ncp1_Nexpr_i_Ptry_deduce_math_2(_Lexpr_2, _Lat_1);
break;
case _Ncp1_Nexpr_type_Ccvar:;
_Ncp1_Nexpr_i_Ptry_deduce_cvar_2(_Lexpr_2, _Lat_1);
break;
}
}
void _Ncp1_Ntype_info_Pinit_1(struct _Ncp1_Ntype_info* _Lti_0) {
...
switch((*_Lexpr_1)._Ftype) {
case _Ncp1_Nexpr_type_Cassign:;
_Ncp1_Nexpr_i_Ptype_assign_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Ccompare:;
_Ncp1_Nexpr_i_Ptype_compare_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cbool:;
_Ncp1_Nexpr_i_Ptype_bool_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cchar:;
_Ncp1_Nexpr_i_Ptype_char_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cmath:;
_Ncp1_Nexpr_i_Ptype_math_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cunary:;
_Ncp1_Nexpr_i_Ptype_unary_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cref:;
_Ncp1_Nexpr_i_Ptype_ref_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Ccast_fast:;
_Ncp1_Nexpr_i_Ptype_cast_fast_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Clvar:;
_Ncp1_Nexpr_i_Ptype_lvar_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cfvar:;
_Ncp1_Nexpr_i_Ptype_fvar_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cgvar:;
_Ncp1_Nexpr_i_Ptype_gvar_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Ccvar:;
_Ncp1_Nexpr_i_Ptype_cvar_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cbools:;
_Ncp1_Nexpr_i_Ptype_bools_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cfunc:;
_Ncp1_Nexpr_i_Ptype_func_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cmethod:;
_Ncp1_Nexpr_i_Ptype_method_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Ci32:;
_Ncp1_Nexpr_i_Ptype_i32_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Csize_of_type:;
_Ncp1_Nexpr_i_Ptype_size_of_type_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cnull:;
_Ncp1_Nexpr_i_Ptype_null_2(_Lexpr_1, &_Lat_2);
break;
case _Ncp1_Nexpr_type_Cindex:;
_Ncp1_Nexpr_i_Ptype_index_2(_Lexpr_1, &_Lat_2);
break;
default:;
fprintf(stdout, "%u:%u - %u:%u: type() not implemented for #%s\n", _Gctx_begin_row, _Gctx_begin_col, _Gctx_end_row, _Gctx_end_col, _Ncp1_Nexpr_type_Pcp1_name_1((*_Lexpr_1)._Ftype));
break;
}
return _Lat_2;
}
inline bool _Ncp1_Nlvar_Pprocess_1(_Ncp1_Nlvar _Ll_0) {
struct _Ncp1_Nlvar_data* _Llvar_1;
_Ncp1_Nat _Lat_i_2;
_Llvar_1 = _Ncp1_Nlvar_Pptr_1(_Ll_0);
if(((*_Llvar_1)._Fflags & _Ncp1_Nlvar_flags_Cprocessed) != _Ncp1_Nlvar_flags_C0) {
return true;
}
(*_Llvar_1)._Fflags |= _Ncp1_Nlvar_flags_Cprocessed;
_Lat_i_2 = (*_Llvar_1)._Fdecl._Ftype;
if(_Lat_i_2 == _Ncp1_Nat_Cnil) {
if(((*_Llvar_1)._Fflags & _Ncp1_Nlvar_flags_Cset_expr) != _Ncp1_Nlvar_flags_C0) {
struct _Ncp1_Nvalue _Lv_3;
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Llvar_1)._Fset_expr, 1, false, &_Lv_3))) {
return false;
}
(*_Llvar_1)._Fdecl._Ftype = _Lv_3._Ftype;
_Ncp1_Ntype_info_Pinit_1(&(*_Llvar_1)._Fdecl._Ftype_info);
_Ncp1_Ntype_info_Pcopy_from_2(&(*_Llvar_1)._Fdecl._Ftype_info, &_Lv_3._Finfo);
} else {
...
return _Ncp1_Ndecl_var_data_Pprocess_5(&(*_Llvar_1)._Fdecl, (*_Gctx_func)._Ffile, (*_Llvar_1)._Frow, (*_Llvar_1)._Fcol, (*_Gctx_func)._Fat);
}
bool _Ncp1_Ngvar_Pprocess_1(_Ncp1_Ngvar _Lg_0) {
uint32_t _Lnum_1;
uint32_t _Ln3_2;
int32_t _Ln17_3;
struct _Ncp1_Ndecl_gvar* _Lgvar_4;
_Ncp1_Nat _Lat_i_5;
struct _Ncp1_Nat_data* _Lat_6;
...
_Lat_6 = _Ncp1_Nat_Pptr_1(_Lat_i_5);
if(!(_Ncp1_Ndecl_var_data_Pprocess_5(&(*_Lgvar_4)._Fdecl, (*_Lgvar_4)._Ffile, (*_Lgvar_4)._Frow, (*_Lgvar_4)._Fcol, (*_Lgvar_4)._Fat))) {
return false;
}
if(((*_Lgvar_4)._Fflags & _Ncp1_Ngvar_flags_Cno_decl) == _Ncp1_Ngvar_flags_C0) {
...
int32_t _Lr_6;
_Lce_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
if(_Lca_ref_1 != 0) {
_Lr_6 = (1 + _Lca_ref_1);
} else {
_Lr_6 = 1;
...
if((*_Lce_5)._Ftype == _Ncp1_Nexpr_type_Clvar) {
struct _Ncp1_Nexpr_lvar* _Lve_7;
struct _Ncp1_Nlvar_data* _Llvar_8;
struct _Ncp1_Ndecl_var_data* _Lvd_9;
_Lve_7 = _Lce_5;
_Llvar_8 = _Ncp1_Nlvar_Pptr_1((*_Lve_7)._Flvar);
_Lvd_9 = (&(*_Llvar_8)._Fdecl);
if((*_Lvd_9)._Ftype == _Ncp1_Nat_Cnil) {
if(((*_Llvar_8)._Fflags & _Ncp1_Nlvar_flags_Cset_expr) == _Ncp1_Nlvar_flags_C0) {
(*_Lvd_9)._Ftype = (*_Lfd_arg_3)._Ftype;
_Ncp1_Ntype_info_Pinit_1(&(*_Lvd_9)._Ftype_info);
_Ncp1_Ntype_info_Pcopy_from_2(&(*_Lvd_9)._Ftype_info, &(*_Lfd_arg_3)._Ftype_info);
...
_Ncp1_Nexpr_i_Ptry_deduce_2(_Le_0, (*_Lfd_arg_3)._Ftype);
if(!(_Ncp1_Nexpr_i_Pvalue_4(_Le_0, _Lr_6, false, _Lca_value_2))) {
return false;
}
return true;
}
inline void _Ncp1_Nexpr_i_Pvalue_assign_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_assign* _Lexpr_5;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
if(_Ncp1_Nexpr_i_Pvalue_4((*_Lexpr_5)._Fleft, 1, _Lparen_2, _Lv_3) == false) {
return;
}
...
inline void _Ncp1_Nexpr_i_Pvalue_compare_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_compare* _Lexpr_5;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cbool);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
...
inline void _Ncp1_Nexpr_i_Pvalue_bool_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cbool);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
(*_Lv_3)._Finfo._Farray_c = 0;
(*_Lv_3)._Finfo._Fref_v[0] = '\0';
...
inline void _Ncp1_Nexpr_i_Pvalue_char_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cchar);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
(*_Lv_3)._Finfo._Farray_c = 0;
(*_Lv_3)._Finfo._Fref_v[0] = '\0';
(*_Lv_3)._Finfo._Fstar_c = 0;
...
inline void _Ncp1_Nexpr_i_Pvalue_math_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_math* _Lexpr_5;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
if(!(_Ncp1_Nexpr_i_Pvalue_4((*_Lexpr_5)._Fleft, 1, _Lparen_2, _Lv_3))) {
return;
}
(*_Lv_3)._Fparen = _Lparen_2;
(*_Lv_3)._Fref = _Lref_1;
...
inline void _Ncp1_Nexpr_i_Pvalue_unary_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_unary* _Lexpr_5;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
(*_Lv_3)._Ftype = _Ncp1_Nexpr_i_Ptype_1((*_Lexpr_5)._Fexpr);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
(*_Lv_3)._Finfo._Farray_c = 0;
(*_Lv_3)._Finfo._Fref_v[0] = 0;
(*_Lv_3)._Finfo._Fstar_c = 0;
...
inline void _Ncp1_Nexpr_i_Pvalue_ref_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_ref* _Lexpr_5;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cref);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
(*_Lv_3)._Finfo._Farray_c = 0;
...
inline void _Ncp1_Nexpr_i_Pvalue_cast_fast_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_cast_fast* _Lexpr_5;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
_Ncp1_Nexpr_i_Pvalue_4((*_Lexpr_5)._Fexpr, _Lref_1, _Lparen_2, _Lv_3);
(*_Lv_3)._Ftype = (*_Lexpr_5)._Ftype;
(*_Lok_4) = true;
}
inline void _Ncp1_Nexpr_i_Pvalue_lvar_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_lvar* _Lexpr_5;
struct _Ncp1_Nlvar_data* _Llvar_6;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
_Llvar_6 = _Ncp1_Nlvar_Pptr_1((*_Lexpr_5)._Flvar);
_Ncp1_Nvalue_Pset_5(_Lv_3, _Lref_1, _Lparen_2, (*_Llvar_6)._Fdecl._Ftype, &(*_Llvar_6)._Fdecl._Ftype_info);
if((*_Lv_3)._Fref == 1) {
(*_Lv_3)._Fparen = false;
}
(*_Lok_4) = true;
}
inline void _Ncp1_Nexpr_i_Pvalue_fvar_5(_Ncp1_Nexpr_i _Lexpr_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_fvar* _Le_5;
struct _Ncp1_Nfvar_data* _Lfvar_6;
_Le_5 = _Ncp1_Nexpr_i_Pptr_1(_Lexpr_0);
_Lfvar_6 = (&(*_Ncp1_Nstruct_Pptr_1((*_Ncp1_Nat_Pptr_1((*_Le_5)._Fval._Ftype))._Fdecl._Fstruct))._Ffvar_v[(*_Le_5)._Ffvar]);
_Ncp1_Nvalue_Pset_5(_Lv_3, _Lref_1, _Lparen_2, (*_Lfvar_6)._Fdecl._Ftype, &(*_Lfvar_6)._Fdecl._Ftype_info);
if((*_Lv_3)._Fref == 1) {
(*_Lv_3)._Fparen = false;
}
(*_Lok_4) = true;
}
inline void _Ncp1_Nexpr_i_Pvalue_gvar_5(_Ncp1_Nexpr_i _Lg_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_gvar* _Le_5;
struct _Ncp1_Ndecl_gvar* _Lgvar_6;
_Le_5 = _Ncp1_Nexpr_i_Pptr_1(_Lg_0);
_Lgvar_6 = _Ncp1_Ngvar_Pptr_1((*_Le_5)._Fgvar);
_Ncp1_Nvalue_Pset_5(_Lv_3, _Lref_1, _Lparen_2, (*_Lgvar_6)._Fdecl._Ftype, &(*_Lgvar_6)._Fdecl._Ftype_info);
if((*_Lv_3)._Fref == 1) {
(*_Lv_3)._Fparen = false;
}
(*_Lok_4) = true;
}
inline void _Ncp1_Nexpr_i_Pvalue_cvar_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_cvar* _Lexpr_5;
struct _Ncp1_Ncvar_data* _Lcvar_6;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
_Lcvar_6 = _Ncp1_Ncvar_Pptr_1((*_Lexpr_5)._Fcvar);
_Ncp1_Nvalue_Pset_5(_Lv_3, _Lref_1, _Lparen_2, (*_Lcvar_6)._Fdecl._Ftype, &(*_Lcvar_6)._Fdecl._Ftype_info);
if((*_Lv_3)._Fref == 1) {
(*_Lv_3)._Fparen = false;
}
(*_Lok_4) = true;
}
inline void _Ncp1_Nexpr_i_Pvalue_bools_5(_Ncp1_Nexpr_i _Le_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cbool);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
(*_Lv_3)._Finfo._Farray_c = 0;
(*_Lv_3)._Finfo._Fref_v[0] = '\0';
...
inline void _Ncp1_Nexpr_i_Pvalue_func_5(_Ncp1_Nexpr_i _Le_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_func* _Lexpr_5;
struct _Ncp1_Ndecl_func* _Lf_6;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
_Lf_6 = _Ncp1_Nfunc_Pptr_1((*_Lexpr_5)._Ffunc_idx);
_Ncp1_Nvalue_Pset_5(_Lv_3, _Lref_1, _Lparen_2, (*_Lf_6)._Fdecl._Ftype, &(*_Lf_6)._Fdecl._Ftype_info);
if((*_Lv_3)._Fref == 1) {
(*_Lv_3)._Fparen = false;
}
(*_Lok_4) = true;
}
inline void _Ncp1_Nexpr_i_Pvalue_method_5(_Ncp1_Nexpr_i _Le_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_method* _Lexpr_5;
struct _Ncp1_Ndecl_func* _Lf_6;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
_Lf_6 = _Ncp1_Nfunc_Pptr_1((*_Lexpr_5)._Ffunc_idx);
_Ncp1_Nvalue_Pset_5(_Lv_3, _Lref_1, _Lparen_2, (*_Lf_6)._Fdecl._Ftype, &(*_Lf_6)._Fdecl._Ftype_info);
...
inline void _Ncp1_Nexpr_i_Pvalue_str_5(_Ncp1_Nexpr_i _Ls_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cchar);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
...
inline void _Ncp1_Nexpr_i_Pvalue_i32_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Ci32);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
(*_Lv_3)._Finfo._Farray_c = 0;
(*_Lv_3)._Finfo._Fref_v[0] = '\0';
(*_Lv_3)._Finfo._Fstar_c = 0;
...
inline void _Ncp1_Nexpr_i_Pvalue_size_of_type_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cusz);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
(*_Lv_3)._Finfo._Farray_c = 0;
(*_Lv_3)._Finfo._Fref_v[0] = '\0';
(*_Lv_3)._Finfo._Fstar_c = 0;
...
inline void _Ncp1_Nexpr_i_Pvalue_null_5(_Ncp1_Nexpr_i _Lle_0, int32_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
(*_Lv_3)._Ftype = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cref);
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
(*_Lv_3)._Finfo._Farray_c = 0;
(*_Lv_3)._Finfo._Fref_v[0] = '\0';
...
inline void _Ncp1_Nexpr_i_Pvalue_index_5(_Ncp1_Nexpr_i _Le_0, int8_t _Lref_1, bool _Lparen_2, struct _Ncp1_Nvalue* _Lv_3, bool* _Lok_4) {
struct _Ncp1_Nexpr_index* _Lexpr_5;
int8_t _Lc_6;
_Lexpr_5 = _Ncp1_Nexpr_i_Pptr_1(_Le_0);
(*_Lv_3)._Ftype = (*_Lexpr_5)._Fleft_val._Ftype;
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_3)._Finfo);
_Ncp1_Ntype_info_Pcopy_from_2(&(*_Lv_3)._Finfo, &(*_Lexpr_5)._Fleft_val._Finfo);
(*_Lv_3)._Finfo._Farray_c -= 1;
...
_Ncp1_Ntype_info_Pcount_1(&(*_Lv_3)._Finfo);
if((*_Lv_3)._Fref == 1) {
(*_Lv_3)._Fparen = false;
} else {
(*_Lv_3)._Fparen = _Lparen_2;
...
inline void _Ncp1_Nexpr_i_Ptry_deduce_math_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat _Lat_1) {
struct _Ncp1_Nexpr_math* _Le_2;
_Le_2 = _Lexpr_0;
_Ncp1_Nexpr_i_Ptry_deduce_2((*_Le_2)._Fleft, _Lat_1);
_Ncp1_Nexpr_i_Ptry_deduce_2((*_Le_2)._Fright, _Lat_1);
int32_t _Li_3;
_Li_3 = 0;
for(int i = (*_Le_2)._Fitem_c; i > 0; ) {
i --;
_Ncp1_Nexpr_i_Ptry_deduce_2((*_Le_2)._Fitem_v[_Li_3]._Fexpr, _Lat_1);
continue_0:;
_Li_3++;
}
break_0:;
}
inline void _Ncp1_Nexpr_i_Ptry_deduce_cvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat _Lat_1) {
struct _Ncp1_Nexpr_cvar* _Le_2;
_Le_2 = _Lexpr_0;
if((*_Le_2)._Fat == _Ncp1_Nat_Cnil) {
(*_Le_2)._Ftry = _Lat_1;
...
inline void _Ncp1_Nexpr_i_Ptype_assign_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_assign* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = _Ncp1_Nexpr_i_Ptype_1((*_Le_2)._Fleft);
}
inline void _Ncp1_Nexpr_i_Ptype_compare_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_compare* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cbool);
}
inline void _Ncp1_Nexpr_i_Ptype_bool_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
(*_Lat_1) = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cbool);
}
inline void _Ncp1_Nexpr_i_Ptype_char_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
(*_Lat_1) = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cchar);
}
inline void _Ncp1_Nexpr_i_Ptype_math_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_math* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = _Ncp1_Nexpr_i_Ptype_1((*_Le_2)._Fleft);
}
inline void _Ncp1_Nexpr_i_Ptype_unary_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_unary* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = _Ncp1_Nexpr_i_Ptype_1((*_Le_2)._Fexpr);
}
inline void _Ncp1_Nexpr_i_Ptype_ref_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
(*_Lat_1) = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cref);
}
inline void _Ncp1_Nexpr_i_Ptype_cast_fast_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_cast_fast* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = (*_Le_2)._Ftype;
}
inline void _Ncp1_Nexpr_i_Ptype_lvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_lvar* _Le_2;
struct _Ncp1_Nlvar_data* _Llvar_3;
_Le_2 = _Lexpr_0;
_Llvar_3 = _Ncp1_Nlvar_Pptr_1((*_Le_2)._Flvar);
(*_Lat_1) = (*_Llvar_3)._Fdecl._Ftype;
}
inline void _Ncp1_Nexpr_i_Ptype_fvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_fvar* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = (*_Ncp1_Nstruct_Pptr_1((*_Ncp1_Nat_Pptr_1((*_Le_2)._Fval._Ftype))._Fdecl._Fstruct))._Ffvar_v[(*_Le_2)._Ffvar]._Fdecl._Ftype;
}
inline void _Ncp1_Nexpr_i_Ptype_gvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_gvar* _Le_2;
...
inline void _Ncp1_Nexpr_i_Ptype_cvar_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_cvar* _Le_2;
...
inline void _Ncp1_Nexpr_i_Ptype_bools_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
(*_Lat_1) = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cbool);
}
inline void _Ncp1_Nexpr_i_Ptype_func_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_func* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = (*_Ncp1_Nfunc_Pptr_1((*_Le_2)._Ffunc_idx))._Fdecl._Ftype;
}
inline void _Ncp1_Nexpr_i_Ptype_method_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_method* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = (*_Ncp1_Nfunc_Pptr_1((*_Le_2)._Ffunc_idx))._Fdecl._Ftype;
}
inline void _Ncp1_Nexpr_i_Ptype_i32_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
(*_Lat_1) = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Ci32);
}
inline void _Ncp1_Nexpr_i_Ptype_size_of_type_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
(*_Lat_1) = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cusz);
}
inline void _Ncp1_Nexpr_i_Ptype_null_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
(*_Lat_1) = _Ncp1_Pbasic_type_1(_Ncp1_Nbasic_type_id_Cref);
}
inline void _Ncp1_Nexpr_i_Ptype_index_2(struct _Ncp1_Nexpr* _Lexpr_0, _Ncp1_Nat* _Lat_1) {
struct _Ncp1_Nexpr_index* _Le_2;
_Le_2 = _Lexpr_0;
(*_Lat_1) = _Ncp1_Nexpr_i_Ptype_1((*_Le_2)._Fleft);
}
...
_Ncp1_Ntype_info_Pinit_1(&(*_Lv_0)._Finfo);
_Ncp1_Ntype_info_Pcopy_from_2(&(*_Lv_0)._Finfo, _Linfo_4);
(*_Lv_0)._Finfo._Fref_v[(*_Lv_0)._Finfo._Farray_c] = (_Lref_1 - 1);
_Ncp1_Ntype_info_Pcount_1(&(*_Lv_0)._Finfo);
