...
_Lf_i_29 = _Gprocess_first;
_Gprocess_first = _NCp1_NFunc_Cnil;
_Gprocess_last = _NCp1_NFunc_Cnil;
while(1) {
struct _NCp1_NDeclFunc* _Lf_30;
if(!_NCp1_NFunc_Pprocess_now_1(_Lf_i_29)) {
return -1;
}
_Lf_30 = _NCp1_NFunc_Pptr_1(_Lf_i_29);
_Lf_i_29 = (*_Lf_30)._Fprocess_next;
if(_Lf_i_29 == _NCp1_NFunc_Cnil) {
goto break_5;
}
continue_5:;
}
...
_Lf_idx_32 = _Gfunc_head_outputted_v[_Li_31];
_Lf_33 = _NCp1_NFunc_Pptr_1(_Lf_idx_32);
if(((*_Lf_33)._Fflags & _NCp1_NFuncFlags_Cno_decl) != _NCp1_NFuncFlags_C0) {
goto continue_6;
}
if(((*_Lf_33)._Fflags & _NCp1_NFuncFlags_Cdecl) != _NCp1_NFuncFlags_C0) {
goto continue_6;
}
_Gctx_func = _Lf_33;
_NCp1_NLvar _Ll_34;
_Ll_34 = (_NCp1_NLvar)(0);
for(int i = (*_Lf_33)._Flvar_c; i > 0; ) {
i --;
if(!_NCp1_NLvar_Pprocess_1(_Ll_34)) {
exit(_NLibC_NExit_Cfailure);
}
continue_7:;
_Ll_34++;
...
int32_t _Lrow_38;
int32_t _Lcol_39;
_Lf_idx_36 = _Gfunc_head_outputted_v[_Li_35];
_Lf_37 = _NCp1_NFunc_Pptr_1(_Lf_idx_36);
_Lrow_38 = (*_Lf_37)._Fbegin_row;
_Lcol_39 = (*_Lf_37)._Fbegin_col;
if((*_Lf_37)._Fdecl._Ftype != _NCp1_NAt_Cnil) {
_NCp1_NAt_Poutput_4((*_Lf_37)._Fdecl._Ftype, (*_Lf_37)._Ffile, _Lrow_38, _Lcol_39);
}
int32_t _Li_40;
_Li_40 = 0;
for(int i = (*_Lf_37)._Ffarg_c; i > 0; ) {
i --;
_NCp1_NAt_Poutput_4((*_Lf_37)._Ffarg_v[_Li_40]._Fdecl._Ftype, (*_Lf_37)._Ffile, _Lrow_38, _Lcol_39);
continue_9:;
_Li_40++;
}
break_9:;
if((*_Lf_37)._Finclude != _NCp1_NInclude_Cnil) {
_NCp1_NInclude_Poutput_1((*_Lf_37)._Finclude);
}
if(((*_Lf_37)._Fflags & _NCp1_NFuncFlags_Ccp1_name) != _NCp1_NFuncFlags_C0) {
struct _NCp1_NAtData* _Lat_41;
_Lat_41 = _NCp1_NAt_Pptr_1((*_Lf_37)._Fat);
int32_t _Li_42;
_NCp1_NCvar* _Lv_43;
_Li_42 = 0;
_Lv_43 = (*_Lat_41)._Fcvar_v;
for(int i = (*_Lat_41)._Fcvar_c; i > 0; ) {
i --;
_NCp1_NCvar _Lcvar_44;
_Lcvar_44 = _Lv_43[_Li_42];
if(((*_NCp1_NCvar_Pptr_1(_Lcvar_44))._Fflags & _NCp1_NCvarFlags_Cas_enum) != _NCp1_NCvarFlags_C0) {
_NCp1_NCvar_Pprocess_1(_Lcvar_44);
}
continue_10:;
_Li_42++;
}
...
_Linc_46 = _Ginclude_outputted_v[_Li_45];
fprintf(_Gout, "#include %s\n", _NCp1_NInclude_Pstr_1(_Linc_46));
continue_11:;
_Li_45++;
}
break_11:;
...
if(((*_Lc_49)._Fdecl._Fflags & _NCp1_NVarFlags_Cno_decl) != _NCp1_NVarFlags_C0) {
goto continue_12;
}
fprintf(_Gout, "#define ");
_NCp1_NCvar_Pwrite_1(_Lc_i_48);
fprintf(_Gout, " ");
if(((*_Lc_49)._Fflags & _NCp1_NCvarFlags_Cset_expr) != _NCp1_NCvarFlags_C0) {
fprintf(_Gout, "(");
_NCp1_NExprI_Pwrite_1((*_Lc_49)._Fexpr_set);
fprintf(_Gout, ")");
} else if((*_Lc_49)._Flast_cvar != _NCp1_NCvar_Cnil) {
fprintf(_Gout, "(");
_NCp1_NCvar_Pwrite_1((*_Lc_49)._Flast_cvar);
fprintf(_Gout, " + 1)");
} else {
fprintf(_Gout, "0");
}
...
i --;
_NCp1_NEnum _Le_i_51;
struct _NCp1_NEnumData* _Le_52;
_Le_i_51 = _Genum_outputted_v[_Li_50];
_Le_52 = _NCp1_NEnum_Pptr_1(_Le_i_51);
fprintf(_Gout, "typedef ");
_NCp1_NAt_Pwrite_1((*_Le_52)._Fbase_type);
fprintf(_Gout, " ");
_NCp1_NAt_Pwrite_1((*_Le_52)._Fat);
fprintf(_Gout, ";\n");
continue_13:;
_Li_50++;
}
...
i --;
_NCp1_NStruct _Ls_i_54;
struct _NCp1_NStructData* _Ls_55;
_Ls_i_54 = _Gstruct_outputted_v[_Li_53];
_Ls_55 = _NCp1_NStruct_Pptr_1(_Ls_i_54);
if(((*_Ls_55)._Fflags & _NCp1_NStructFlags_Cunion) != _NCp1_NStructFlags_C0) {
fprintf(_Gout, "union ");
} else {
fprintf(_Gout, "struct ");
}
_NCp1_NAt_Pwrite_space_1((*_Ls_55)._Fat);
if(((*_Ls_55)._Fflags & _NCp1_NStructFlags_Cunion) != _NCp1_NStructFlags_C0) {
fprintf(_Gout, ";\nunion ");
} else {
fprintf(_Gout, ";\nstruct ");
...
int32_t _Lj_56;
_Lj_56 = 0;
for(int i = (*_Ls_55)._Ffvar_c; i > 0; ) {
i --;
struct _NCp1_NFvarData* _Lfvar_57;
_Lfvar_57 = (&(*_Ls_55)._Ffvar_v[_Lj_56]);
_NCp1_NDeclVarData_Pwrite_type_2(&(*_Lfvar_57)._Fdecl, _NCp1_NDeclVarType_Cfvar);
fprintf(_Gout, ";\n");
continue_15:;
_Lj_56++;
}
...
i --;
_NCp1_NGvar _Lg_i_59;
struct _NCp1_NDeclGvar* _Lg_60;
_Lg_i_59 = _Ggvar_outputted_v[_Li_58];
_Lg_60 = _NCp1_NGvar_Pptr_1(_Lg_i_59);
if(((*_Lg_60)._Fdecl._Fflags & _NCp1_NVarFlags_Cno_decl) != _NCp1_NVarFlags_C0) {
goto continue_16;
}
if(((*_Lg_60)._Fdecl._Fflags & _NCp1_NVarFlags_Cextern) != _NCp1_NVarFlags_C0) {
fprintf(_Gout, "extern ");
}
_NCp1_NDeclVarData_Pwrite_type_2(&(*_Lg_60)._Fdecl, _NCp1_NDeclVarType_Cgvar);
fprintf(_Gout, ";\n");
continue_16:;
_Li_58++;
}
...
_Lf_idx_62 = _Gfunc_head_outputted_v[_Li_61];
_Lf_63 = _NCp1_NFunc_Pptr_1(_Lf_idx_62);
if(((*_Lf_63)._Fflags & _NCp1_NFuncFlags_Cno_decl) != _NCp1_NFuncFlags_C0) {
goto continue_17;
}
if(((*_Lf_63)._Fflags & _NCp1_NFuncFlags_Cdecl) != _NCp1_NFuncFlags_C0) {
if((((*_Lf_63)._Fdecl_str[0] == '#') && ((*_Lf_63)._Fdecl_str[1] == ' '))) {
fprintf(_Gout, "#define ");
_NCp1_NDeclFunc_Pwrite_1(_Lf_63);
fprintf(_Gout, "(");
int32_t _Lj_64;
_Lj_64 = 0;
for(int i = (*_Lf_63)._Ffarg_c; i > 0; ) {
i --;
if(_Lj_64 != 0) {
fprintf(_Gout, ", ");
}
fprintf(_Gout, "%s", _NCp1_NId_Pstr_1((*_Lf_63)._Ffarg_v[_Lj_64]._Fdecl._Fname));
continue_18:;
_Lj_64++;
}
break_18:;
fprintf(_Gout, ") ");
fprintf(_Gout, "%.*s\n", (*_Lf_63)._Fdecl_len - 2, &(*_Lf_63)._Fdecl_str[2]);
} else {
fprintf(_Gout, "%.*s\n", (*_Lf_63)._Fdecl_len, (*_Lf_63)._Fdecl_str);
}
goto continue_17;
}
_Gctx_func = _Lf_63;
if((*_Lf_63)._Fdecl._Ftype == _NCp1_NAt_Cnil) {
fprintf(_Gout, "void");
} else {
_NCp1_NAt_Pwrite_type_info_3((*_Lf_63)._Fdecl._Ftype, &(*_Lf_63)._Fdecl._Ftype_info, 0);
}
fprintf(_Gout, " ");
_NCp1_NDeclFunc_Pwrite_1(_Lf_63);
fprintf(_Gout, "(");
...
_NCp1_NDeclVarData_Pwrite_lvar_type_2(&(*_Lf_63)._Ffarg_v[_Lj_65]._Fdecl, (_NCp1_NLvar)(_Lj_65));
continue_19:;
_Lj_65++;
}
break_19:;
if(((*_Lf_63)._Fflags & _NCp1_NFuncFlags_Ccp1_name) != _NCp1_NFuncFlags_C0) {
struct _NCp1_NAtData* _Lat_66;
fprintf(_Gout, ") {\nswitch(_Le_0) {\n");
_Lat_66 = _NCp1_NAt_Pptr_1((*_Lf_63)._Fat);
int32_t _Li_67;
_NCp1_NCvar* _Lv_68;
_Li_67 = 0;
_Lv_68 = (*_Lat_66)._Fcvar_v;
for(int i = (*_Lat_66)._Fcvar_c; i > 0; ) {
i --;
_NCp1_NCvar _Lcvar_i_69;
struct _NCp1_NCvarData* _Lcvar_70;
_Lcvar_i_69 = _Lv_68[_Li_67];
_Lcvar_70 = _NCp1_NCvar_Pptr_1(_Lcvar_i_69);
if(((*_Lcvar_70)._Fflags & _NCp1_NCvarFlags_Cas_enum) == _NCp1_NCvarFlags_C0) {
goto continue_20;
}
fprintf(_Gout, "case ");
_NCp1_NCvar_Pwrite_1(_Lcvar_i_69);
fprintf(_Gout, ": return \"%s\";\n", _NCp1_NId_Pstr_1((*_Lcvar_70)._Fdecl._Fname));
continue_20:;
_Li_67++;
}
break_20:;
...
_Lf_idx_72 = _Gfunc_body_outputted_v[_Li_71];
_Lf_73 = _NCp1_NFunc_Pptr_1(_Lf_idx_72);
_Gctx_func = _Lf_73;
_Gnest_id = 0;
if((*_Lf_73)._Fflags & _NCp1_NFuncFlags_Cinline) {
fprintf(_Gout, "inline ");
}
if((*_Lf_73)._Fdecl._Ftype == _NCp1_NAt_Cnil) {
fprintf(_Gout, "void");
} else {
_NCp1_NAt_Pwrite_type_info_3((*_Lf_73)._Fdecl._Ftype, &(*_Lf_73)._Fdecl._Ftype_info, 0);
}
fprintf(_Gout, " ");
_NCp1_NDeclFunc_Pwrite_1(_Lf_73);
fprintf(_Gout, "(");
int32_t _Lj_74;
_Lj_74 = 0;
for(int i = (*_Lf_73)._Ffarg_c; i > 0; ) {
i --;
if(_Lj_74 != 0) {
fprintf(_Gout, ", ");
}
_NCp1_NDeclVarData_Pwrite_lvar_type_2(&(*_Lf_73)._Ffarg_v[_Lj_74]._Fdecl, (_NCp1_NLvar)(_Lj_74));
continue_22:;
_Lj_74++;
}
break_22:;
fprintf(_Gout, ") {\n");
_NCp1_NStmtSpace_Pwrite_1(&(*_Lf_73)._Fstmt_space);
fprintf(_Gout, "}\n");
continue_21:;
_Li_71++;
}
