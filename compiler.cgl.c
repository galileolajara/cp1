...
fprintf(_Gout, "%s", _Nglc_Nid_Pstr_1((*_Lt_3)._Freal_name));
return;
}
}
...
struct _Nglc_Nstmt_space* _Lcontinue_3;
_Ls_2 = _Lstmt_0;
_Lcontinue_3 = (*(*_Ls_2)._Fdo)._Fcontinue;
if(_Lcontinue_3 != NULL) {
_Nglc_Nstmt_space_Pprocess_1(_Lcontinue_3);
}
(*_Lok_1) = true;
}
void _Nglc_Nstmt_Pprocess_while_2(struct _Nglc_Nstmt* _Lstmt_0, bool* _Lok_1) {
...
_Lcontinue_3 = (*(*_Ls_2)._Fdo)._Fcontinue;
if(_Lcontinue_3 != NULL) {
_Nglc_Nstmt_space_Pwrite_1(_Lcontinue_3);
}
fprintf(_Gout, "}\nbreak_%u:;\n", _Lid_1);
}
void _Nglc_Nstmt_Pwrite_while_1(struct _Nglc_Nstmt* _Lstmt_0) {
